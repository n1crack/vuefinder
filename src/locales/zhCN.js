...
export default {
    "A modern, customizable file manager component built for Vue.": "为 Vue 构建的现代、可自定义的文件管理器组件。",
    "Project Home": "项目主页",
    "If you like it, please follow and ⭐ star on GitHub.": "如果你喜欢，请关注并在 GitHub 上点 ⭐ 星标。",
    "Language": "语言",
    "Create": "创建",
    "Close": "关闭",
    "Cancel": "取消",
