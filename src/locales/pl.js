...
export default {
  ...
  'Name cannot contain slashes.': 'Nazwa nie może zawierać ukośników.',
  'Zoom in': 'Powiększ',
  'Zoom out': 'Pomniejsz',
  ...
  'Name (A-Z)': 'Nazwa (A-Z)',
  'Name (Z-A)': 'Nazwa (Z-A)',
  'Size (smallest)': 'Rozmiar (najmniejsze)',
  'Size (largest)': 'Rozmiar (największe)',
  'Date (newest)': 'Data (najnowsze)',
  'Date (oldest)': 'Data (najstarsze)',
  'Preview as': 'Podgląd jako',
  Text: 'Tekst',
  Image: 'Obraz',
  Table: 'Tabela',
  Raw: 'Surowy',
  'View as table': 'Pokaż jako tabelę',
  'View as raw': 'Pokaż surowe',
  'Failed to parse CSV': 'Nie udało się przetworzyć CSV',
  'No rows to display': 'Brak wierszy do wyświetlenia',
  'Showing first %s rows out of %s': 'Wyświetlanie pierwszych %s z %s wierszy',
  'Path copied to clipboard': 'Ścieżka skopiowana do schowka',
  'Toggle Path Copy Mode': 'Przełącz tryb kopiowania ścieżki',
