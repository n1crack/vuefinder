...
export default {
  ...
  'Name cannot contain slashes.': 'Имя не может содержать косые черты.',
  'Zoom in': 'Увеличить',
  'Zoom out': 'Уменьшить',
  ...
  'Name (A-Z)': 'Имя (А-Я)',
  'Name (Z-A)': 'Имя (Я-А)',
  'Size (smallest)': 'Размер (по возрастанию)',
  'Size (largest)': 'Размер (по убыванию)',
  'Date (newest)': 'Дата (новые)',
  'Date (oldest)': 'Дата (старые)',
  'Preview as': 'Просмотр как',
  Text: 'Текст',
  Image: 'Изображение',
  Table: 'Таблица',
  Raw: 'Сырой',
  'View as table': 'Показать как таблицу',
  'View as raw': 'Показать как есть',
  'Failed to parse CSV': 'Не удалось разобрать CSV',
  'No rows to display': 'Нет строк для отображения',
  'Showing first %s rows out of %s': 'Показаны первые %s строк из %s',
  'Path copied to clipboard': 'Путь скопирован в буфер обмена',
  'Toggle Path Copy Mode': 'Переключить режим копирования пути',
