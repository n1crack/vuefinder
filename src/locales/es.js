...
export default {
    "A modern, customizable file manager component built for Vue.": "Un gestor de archivos moderno y personalizable creado para Vue.",
    "Project Home": "Página del proyecto",
    "If you like it, please follow and ⭐ star on GitHub.": "Si te gusta, síguenos y añade una ⭐ estrella en GitHub.",
    "Language": "Idioma",
    "Create": "Crear",
    "Close": "Cerrar",
    "Cancel": "Cancelar",
    ...
    "Are you sure you want to move these files?": "¿Estás seguro de que quieres mover estos archivos?",
    ...
    "Canceled": "Cancelado",
    "Done": "Hecho",
    "Network Error, Unable establish connection to the server or interrupted.": "Error de red, No se pudo establecer conexión con el servidor o se interrumpió.",
    ...
    "Download doesn\'t work? You can try right-click \"Download\" button, select \"Save link as...\".": "¿La descarga no funciona? Puedes intentar hacer clic derecho en el botón \"Descargar\", seleccionar \"Guardar enlace como...\".",
    "Theme": "Tema",
    "Dark": "Oscuro",
    "Light": "Claro",
    "System": "Sistema",
    ...
    "Customize your experience with the following settings": "Personaliza tu experiencia con la siguiente configuración",
    "File": "Archivo",
    "View": "Vista",
    "Tools": "Herramientas",
    "Help": "Ayuda",
    ...
    "Are you sure you want to copy these files?": "¿Estás seguro de que quieres copiar estos archivos?",
    "Yes, Copy!": "¡Sí, copiar!",
