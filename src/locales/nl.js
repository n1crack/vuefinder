...
export default {
  ...
  'Persist Path': 'Pad behouden',
  'Metric Units': 'Metrische eenheden',
  ...
  'Failed to rename': 'Hernoemen mislukt',
  'Name cannot contain slashes.': 'De naam mag geen schuine strepen bevatten.',
  'Zoom in': 'Inzoomen',
  'Zoom out': 'Uitzoomen',
  ...
  'Name (A-Z)': 'Naam (A-Z)',
  'Name (Z-A)': 'Naam (Z-A)',
  'Size (smallest)': 'Grootte (kleinste)',
  'Size (largest)': 'Grootte (grootste)',
  'Date (newest)': 'Datum (nieuwste)',
  'Date (oldest)': 'Datum (oudste)',
  'Preview as': 'Voorbeeld als',
  Text: 'Tekst',
  Image: 'Afbeelding',
  Table: 'Tabel',
  Raw: 'Ruw',
  'View as table': 'Als tabel weergeven',
  'View as raw': 'Ruw weergeven',
  'Failed to parse CSV': 'CSV kon niet worden geparseerd',
  'No rows to display': 'Geen rijen om weer te geven',
  'Showing first %s rows out of %s': 'Eerste %s van %s rijen worden weergegeven',
  'Path copied to clipboard': 'Pad gekopieerd naar klembord',
  'Toggle Path Copy Mode': 'Pad-kopieermodus omschakelen',
