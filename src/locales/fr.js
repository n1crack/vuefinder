...
export default {
  ...
  'Persist Path': 'Conserver le chemin',
  'Metric Units': 'Unités métriques',
  ...
  'Failed to rename': 'Échec du renommage',
  'Name cannot contain slashes.': 'Le nom ne peut pas contenir de barres obliques.',
  'Zoom in': 'Zoom avant',
  ...
  'Name (A-Z)': 'Nom (A-Z)',
  'Name (Z-A)': 'Nom (Z-A)',
  'Size (smallest)': 'Taille (la plus petite)',
  'Size (largest)': 'Taille (la plus grande)',
  'Date (newest)': 'Date (la plus récente)',
  'Date (oldest)': 'Date (la plus ancienne)',
  'Preview as': 'Aperçu en tant que',
  Text: 'Texte',
  Image: 'Image',
  Table: 'Tableau',
  Raw: 'Brut',
  'View as table': 'Afficher en tableau',
  'View as raw': 'Afficher en brut',
  'Failed to parse CSV': 'Échec de l’analyse CSV',
  'No rows to display': 'Aucune ligne à afficher',
  'Showing first %s rows out of %s': 'Affichage des %s premières lignes sur %s',
  'Path copied to clipboard': 'Chemin copié dans le presse-papiers',
  'Toggle Path Copy Mode': 'Basculer le mode copie de chemin',
