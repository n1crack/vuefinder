...
export default {
  ...
  'Failed to rename': '重新命名失敗',
  'Name cannot contain slashes.': '名稱不能包含斜線。',
  'Zoom in': '放大',
  'Zoom out': '縮小',
  'Reset zoom': '重設縮放',
  'Sort by': '排序方式',
  ...
  'View as table': '以表格檢視',
  'View as raw': '以原始檢視',
  'Failed to parse CSV': '無法解析 CSV',
  'No rows to display': '沒有可顯示的列',
  'Showing first %s rows out of %s': '顯示 %s 列中的前 %s 列',
  'Path copied to clipboard': '路徑已複製到剪貼簿',
  'Toggle Path Copy Mode': '切換路徑複製模式',
  'Target folder': '目標資料夾',
  'No folders': '無資料夾',
  Pinned: '已釘選',
  'Copy Path': '複製路徑',
