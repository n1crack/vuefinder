...
export default {
  ...
  'Failed to rename': '名前変更に失敗しました',
  'Name cannot contain slashes.': '名前にスラッシュを含めることはできません。',
  'Zoom in': '拡大',
  'Zoom out': '縮小',
  'Reset zoom': 'ズームをリセット',
  'Sort by': '並び替え',
  ...
  Table: 'テーブル',
  Raw: '生データ',
  'View as table': 'テーブル表示',
  'View as raw': '生データ表示',
  'Failed to parse CSV': 'CSVを解析できませんでした',
  'No rows to display': '表示する行がありません',
  'Showing first %s rows out of %s': '%s行中、最初の%s行を表示しています',
  'Path copied to clipboard': 'パスをクリップボードにコピーしました',
  'Toggle Path Copy Mode': 'パスコピーモードの切り替え',
