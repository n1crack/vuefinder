<template>
    <div class="vuefinder-file-previewer">
        <component :url='url' :path="path" :is="preview[type] || preview['default']"></component>
        <slot></slot>
    </div>
</template>
...
import axios from 'axios';
    ...
    var preview = {
        ...
        'file-alt': {
            ...
            mounted() {
                axios(this.url, {params: {path: this.path}}).then(response => {
...
<style lang="scss" scoped>
    ...
    .vuefinder-file-previewer {
        ...
        #{"/deep/"} img, embed, object, audio, video {
            max-width: 100%;
            max-height: 180px;
        }
