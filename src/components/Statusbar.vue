<template>
  <div class="p-1 text-xs border-t border-neutral-300 dark:border-gray-700/50 flex justify-between select-none">
    ...
    <div class="flex leading-5 items-center">
      ...
      <span :aria-label="t('About')" data-microtip-position="top-left" role="tooltip" @click="emitter.emit('vf-modal-show', {type:'message', title:'Vuefinder ' + version, message: t('Vuefinder is a file manager component for vue 3.')})">
