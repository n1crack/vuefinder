<template>
    <modal @close="$emit('close')">
        ...
        <div class="vuefinder-modal-body">
            <div v-for="({file, percentage, done, failed}, key) in files" class="vuefinder-file-listing"
                ...
                <div class="vuefinder-uploaded-extra">
                    ...
                    <button class="remove-file" @click="removeFile( key )" v-else>Remove</button>
                </div>
            </div>
        ...
        <div class="vuefinder-upload-errors" v-if="errors.length > 0 ">
            <div class="vuefinder-upload-clear-errors" @click="errors = []">X</div>
        ...
        <div class="vuefinder-modal-footer">
            <button class="vuefinder-button" @click="addFiles">Add Files</button>
            <button class="vuefinder-button" @click="submitFiles" :disabled="uploadableFiles.length==0">Upload!
                ({{uploadableFiles.length}} items in queue)
            </button>
    ...
    export default {
        ...
        methods: {
            ...
            submitFiles() {
                ...
                this.files.forEach(({file, percentage, done, failed}, index) => {
