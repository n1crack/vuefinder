...
function We(y) {
  ...
  const u = j(JSON.parse(f));
  Ye(u, m);
  function m() {
    u.value === null || u.value === "" ? localStorage.removeItem(y + "_storage") : localStorage.setItem(y + "_storage", JSON.stringify(u.value));
  }
  function v(_, p) {
    u.value = Object.assign({ ...u.value }, { [_]: p });
  }
  function s() {
    u.value = null;
  }
  return { getStore: (_, p = null) => u.value === null || u.value === "" ? p : u.value.hasOwnProperty(_) ? u.value[_] : p, setStore: v, clearStore: s };
}
const er = {
  name: "VueFinder"
  ...
  setup(y) {
    const f = y, u = Qt();
    Fe("emitter", u);
    const { setStore: m, getStore: v } = We(f.id);
    Fe("storage", We(f.id));
    const s = de({ adapter: "local", storages: [], dirname: ".", files: [] }), D = j(v("viewport", "grid")), _ = j(v("darkMode", f.dark));
    u.on("vf-darkMode-toggle", () => {
      _.value = !_.value, m("darkMode", _.value);
    ...
    return u.on("vf-fetch", (b) => {
      Gt(f.url, { params: b }).then((E) => {
        u.emit("vf-modal-close"), P(E);
      });
    }), he(() => {
      u.emit("vf-fetch", { q: "index", adapter: v("adapter", s.adapter) });
    }), (b, E) => {
      const O = U("v-f-toolbar"), H = U("v-f-breadcrumb"), B = U("v-f-explorer"), T = U("v-f-statusbar"), G = U("v-f-context-menu");
      return w(), $("div", {
        class: fe(_.value ? "dark" : "")
      }, [
        i("div", {
          ...
          X(O),
          X(H, { data: s }, null, 8, ["data"]),
          X(B, {
            view: D.value,
            data: s
          }, null, 8, ["view", "data"]),
          X(T, { data: s }, null, 8, ["data"])
        ], 32),
        p.active ? (w(), J(qt("v-f-modal-" + p.type), {
          key: 0,
          selection: p.data,
          current: s
...
}), rr = { class: "border-neutral-300 flex justify-between py-1 text-sm" }, nr = { class: "flex text-center" }, or = /* @__PURE__ */ i("path", {
  ...
  setup(y) {
    const f = inject("emitter"), { getStore: u, setStore: m } = inject("storage"), v = j(u("viewport", "grid")), s = j([]);
    return f.on("vf-nodes-selected", (D) => {
      s.value = D;
    }), f.on("vf-view-toggle", (D) => {
      m("viewport", D), v.value = D;
    }), (D, _) => (w(), $("div", rr, [
      i("div", nr, [
        i("div", {
          class: "mx-1.5",
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: _[0] || (_[0] = (p) => s.value.length != 1 || A(f).emit("vf-modal-show", { type: "rename", items: s.value }))
        }, [
          (w(), $("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: fe([s.value.length == 1 ? "cursor-pointer stroke-gray-800 hover:stroke-cyan-700 dark:stroke-gray-300 dark:hover:stroke-gray-100" : "stroke-gray-200  dark:stroke-gray-600", "h-6 w-6 md:h-8 md:w-8 m-auto"]),
            fill: "none",
            viewBox: "0 0 24 24",
            stroke: "none",
            "stroke-width": "1.5"
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: _[1] || (_[1] = (p) => !s.value.length || A(f).emit("vf-modal-show", { type: "delete", items: s.value }))
        }, [
          (w(), $("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: fe([s.value.length ? "cursor-pointer stroke-gray-800 hover:stroke-cyan-700 dark:stroke-gray-300 dark:hover:stroke-gray-100" : "stroke-gray-200  dark:stroke-gray-600", "h-6 w-6 md:h-8 md:w-8 m-auto"]),
            fill: "none",
            viewBox: "0 0 24 24",
            stroke: "none",
            "stroke-width": "1.5"
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: _[2] || (_[2] = (p) => A(f).emit("vf-modal-show", { type: "new-folder", items: s.value }))
        }, cr),
        i("div", {
          class: "mx-1.5",
          "aria-label": "Upload",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: _[3] || (_[3] = (p) => A(f).emit("vf-modal-show", { type: "message", title: "Custom modal", message: "Custom title" }))
        }, dr)
      ]),
      i("div", hr, [
        i("div", fr, [
          (w(), $("svg", {
            onClick: _[4] || (_[4] = (p) => A(f).emit("vf-darkMode-toggle")),
            width: "36",
            height: "36",
            viewBox: "-6 -6 36 36",
            "stroke-width": "2",
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
            class: "cursor-pointer stroke-sky-500 fill-sky-100 hover:stroke-sky-600 dark:stroke-gray-400 dark:fill-gray-400/20 dark:hover:stroke-gray-300"
          }, gr))
        ]),
        i("div", {
          class: "mx-1.5",
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: _[5] || (_[5] = (p) => A(f).emit("vf-view-toggle", v.value == "list" ? "grid" : "list"))
        }, [
          v.value == "grid" ? (w(), $("svg", vr, br)) : W("", !0),
          v.value == "list" ? (w(), $("svg", yr, _r)) : W("", !0)
        ])
      ])
    ]));
  }
  ...
  setup(y) {
    var p;
    const f = y, u = inject("emitter"), { getStore: m, setStore: v } = inject("storage"), s = j(0), D = j((p = m("adapter")) != null ? p : f.data.adapter), _ = () => {
      u.emit("vf-fetch", { q: "index", adapter: D.value }), v("adapter", D.value);
    };
    return u.on("vf-nodes-selected", (P) => {
      s.value = P.length;
    }), (P, b) => (w(), $("div", kr, [
      i("div", Dr, [
        Cr,
        re(i("select", {
          ...
          (w(!0), $(oe, null, se(y.data.storages, (E) => (w(), $("option", { value: E }, K(E), 9, Pr))), 256))
        ], 544), [
          [Xt, D.value]
        ]),
        i("span", $r, K(s.value > 0 ? s.value + " items selected." : ""), 1)
      ]),
      i("div", Mr, [
        i("span", {
...
var Vr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xe = { exports: {} };
(function(y, f) {
  (function(u, m) {
    y.exports = m();
  })(Vr, function() {
    ...
    function _(n) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2 ? D(Object(e), !0).forEach(function(o) {
          s(n, o, e[o]);
    ...
    function O(n, t, e) {
      return E() ? O = Reflect.construct : O = function(r, a, l) {
        var c = [null];
        c.push.apply(c, a);
        var d = Function.bind.apply(r, c), g = new d();
        return l && b(g, l.prototype), g;
    ...
    function B(n) {
      ...
      return B = function(o) {
        ...
        function r() {
          return O(o, arguments, P(this).constructor);
        }
    ...
    function k(n, t) {
      for (; !Object.prototype.hasOwnProperty.call(n, t) && (n = P(n), n !== null); )
        ;
      return n;
    }
    function M(n, t, e) {
    ...
    function C(n, t) {
      return Y(n) || Je(n, t) || we(n, t) || Qe();
    }
    function F(n) {
      return V(n) || q(n) || we(n) || Ge();
    }
    function V(n) {
      if (Array.isArray(n))
        return me(n);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var N = function(t, e, o) {
      ...
      return !n || n instanceof Document ? ge() : {
        x: n.scrollLeft >= 0 ? n.scrollLeft : ge().x,
        y: n.scrollTop >= 0 ? n.scrollTop : ge().y
      };
    }, ke = function(n) {
      ...
      if (o.transform.indexOf("3d") >= 0) {
        ...
        if (c && c.length) {
          var d, g = (d = c[1]) === null || d === void 0 ? void 0 : d.split(",");
      ...
      var t = n.shiftKey, e = n.keyboardDragSpeed, o = n.zoom, r = n.key, a = n.dragKeys, l = n.scrollDiff, c = n.canScroll, d = n.scrollCallback, g = {
        x: 0,
        y: 0
      }, h = t ? e * 4 * o : e * o;
      return a.left.includes(r) && (g.x = l.x || -h, !t && !l.x && c && d(["left"], e)), a.right.includes(r) && (g.x = l.x || h, !t && !l.x && c && d(["right"], e)), a.up.includes(r) && (g.y = l.y || -h, !t && !l.y && c && d(["top"], e)), a.down.includes(r) && (g.y = l.y || h, !t && !l.y && c && d(["bottom"], e)), g;
    }, mt = function(n) {
      ...
      var t = n.element, e = n.posDirection, o = n.containerRect, r = n.useTransform, a = dt(t, r), l = N(a, "+", e);
      ne(t, l, r);
      ...
      for (var t = n.subscribe, e = n.publish, o = n.Interaction, r = n.SelectedSet, a = {
        ...
        var h = C(d[c], 2), S = h[0], x = h[1];
        ["pre", !1].forEach(function(I) {
          return t(I ? "".concat(S, ":").concat(I) : S, function(z) {
            return x.forEach(function(L) {
              return (!L.condition || L.condition(z)) && e(I ? "".concat(I).concat(L.name) : L.name, _({
                items: r.elements,
      ...
      function n(t) {
        var e = this, o = t.DS, r = t.dragKeys, a = t.draggability, l = t.keyboardDrag, c = t.keyboardDragSpeed, d = t.useTransform, g = t.zoom;
        u(this, n), s(this, "_useTransform", void 0), s(this, "_prevCursorPos", void 0), s(this, "_prevScrollPos", void 0), s(this, "_elements", []), s(this, "_draggability", void 0), s(this, "_dragKeys", void 0), s(this, "_dragKeysFlat", void 0), s(this, "_keyboardDrag", void 0), s(this, "_keyboardDragSpeed", void 0), s(this, "_zoom", void 0), s(this, "keyboardDrag", function(h) {
          ...
          var S = h.isDragging, x = h.isDraggingKeyboard;
          !S || x || (e._prevCursorPos = null, e._prevScrollPos = null, e._elements = e.DS.getSelection(), e.handleZIndex(!0));
          ...
          var S = h.isDragging, x = h.isDraggingKeyboard;
          if (!(!S || !e._elements.length || x || e.DS.continue)) {
          ...
          e._elements.forEach(function(S) {
            return S.style.zIndex = "".concat((parseInt(S.style.zIndex) || 0) + h ? 9999 : -9998);
          });
        }), this.DS = o, this._useTransform = d, this._keyboardDragSpeed = c, this._keyboardDrag = l, this._zoom = g, this._draggability = a, this._dragKeys = {
      ...
      function n(t) {
        ...
        u(this, n), s(this, "_areaElement", void 0), s(this, "_draggability", void 0), s(this, "_immediateDrag", void 0), s(this, "_selectableClass", void 0), s(this, "isInteracting", void 0), s(this, "isDragging", void 0), s(this, "init", function() {
          ...
          var g = d.target.closest(".".concat(e._selectableClass));
          return !e._draggability || e.DS.stores.KeyStore.isMultiSelectKeyPressed(d) || !g ? !1 : (e._immediateDrag && (e.DS.SelectedSet.size ? e.DS.SelectedSet.has(g) || (e.DS.SelectedSet.clear(), e.DS.SelectedSet.add(
            g
          ...
          if (!!e._canInteract(g) && !(g.detail > 0)) {
            var h = e.DS, S = h.stores, x = S.PointerStore, I = S.KeyStore, z = h.SelectableSet, L = h.SelectedSet;
            x.start(g);
            var te = g.target;
            !z.has(te) || (I.isMultiSelectKeyPressed(g) || L.clear(), L.toggle(te), e.reset());
          }
        }), s(this, "stop", function() {
          ...
          var g = d.event, h = d.scroll_directions, S = d.scroll_multiplier;
      ...
      var t = ie(e);
      function e(o) {
        var r, a = o.elements, l = o.className, c = o.hoverClassName, d = o.draggability, g = o.useTransform, h = o.DS;
        return u(this, e), r = t.call(this), s(T(r), "_initElements", void 0), s(T(r), "_className", void 0), s(T(r), "_hoverClassName", void 0), s(T(r), "_useTransform", void 0), s(T(r), "_draggability", void 0), s(T(r), "init", function() {
          return r._initElements.forEach(function(S) {
            return r.add(S);
          });
        ...
        }), s(T(r), "_onClick", function(S) {
          return r.DS.publish(["Selectable:click:pre", "Selectable:click"], {
            event: S
          });
        }), s(T(r), "_onPointer", function(S) {
          return r.DS.publish(["Selectable:pointer:pre", "Selectable:pointer"], {
            event: S
          });
        }), s(T(r), "addAll", function(S) {
          return S.forEach(function(x) {
            return r.add(x);
          });
        }), s(T(r), "deleteAll", function(S) {
          return S.forEach(function(x) {
            return r.delete(x);
          });
        }), r.DS = h, r._initElements = ee(a), r._className = l, r._hoverClassName = c, r._useTransform = g, r._draggability = d, r.DS.subscribe("Interaction:init", r.init), r;
      }
      return v(e, [{
        key: "add",
        value: function(r) {
          return r.classList.add(this._className), r.addEventListener("click", this._onClick), r.addEventListener("mousedown", this._onPointer), r.addEventListener("touchstart", this._onPointer, {
            ...
            node: r
          }), M(P(e.prototype), "add", this).call(this, r);
        }
      }, {
        key: "delete",
        value: function(r) {
          return r.classList.remove(this._className), r.classList.remove(this._hoverClassName), r.removeEventListener("click", this._onClick), r.removeEventListener("mousedown", this._onPointer), r.removeEventListener("touchstart", this._onPointer, {
            passive: !1
          }), M(P(e.prototype), "delete", this).call(this, r);
        }
      }, {
        key: "elements",
        get: function() {
      ...
      return v(e, [{
        key: "add",
        value: function(r) {
          if (!M(P(e.prototype), "has", this).call(this, r)) {
            var a = {
              items: this.elements,
              item: r
            };
            return this.DS.publish("Selected:added:pre", a), M(P(e.prototype), "add", this).call(this, r), r.classList.add(this._className), r.style.zIndex = "".concat((parseInt(r.style.zIndex) || 0) + 1), this.DS.publish("Selected:added", a), this;
          }
        }
      }, {
        key: "delete",
        value: function(r) {
          if (!!M(P(e.prototype), "has", this).call(this, r)) {
            ...
            var l = M(P(e.prototype), "delete", this).call(this, r);
      ...
      function n(t) {
        ...
        u(this, n), s(this, "_prevSelectedSet", void 0), s(this, "_hoverClassName", void 0), s(this, "_multiSelectToggling", void 0), s(this, "start", function(l) {
          ...
          for (var d = e.DS, g = d.SelectableSet, h = d.SelectorArea, S = d.Selector, x = g.elements.map(function(Z) {
            return [Z, Z.getBoundingClientRect()];
          }), I = [], z = [], L = 0, te = x.length; L < te; L++)
            !h.isInside(x[L][0], x[L][1]) || (ve(x[L][1], S.rect) ? I.push(x[L][0]) : z.push(x[L][0]));
      ...
      function n(t) {
        ...
        u(this, n), s(this, "_autoScrollSpeed", void 0), s(this, "_scrollInterval", void 0), s(this, "_rect", void 0), s(this, "currentEdges", []), s(this, "_overflowTolerance", void 0), s(this, "start", function() {
          ...
          var c = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "append", d = document.body ? "body" : "documentElement", g = "".concat(c, "Child");
          e.HTMLNode[g](e.DS.Selector.HTMLNode), document[d][g](e.HTMLNode);
        }), s(this, "updatePos", function() {
          e._rect = null;
          var c = e.DS.Area.rect, d = e.DS.Area.computedBorder, g = e.HTMLNode.style, h = "".concat(c.top + d.top, "px"), S = "".concat(c.left + d.left, "px"), x = "".concat(c.width, "px"), I = "".concat(c.height, "px");
          g.top !== h && (g.top = h), g.left !== S && (g.left = S), g.width !== x && (g.width = x), g.height !== I && (g.height = I);
          ...
          if (!e.DS.continue) {
            var c = e.DS, d = c.stores.PointerStore, g = c.Area;
            e.currentEdges = ke({
          ...
          return e.DS.Area.HTMLNode.contains(c) && e.DS.stores.ScrollStore.canScroll ? !0 : ve(e.rect, d || c.getBoundingClientRect());
      ...
      return v(n, [{
        ...
        key: "scrollAmount",
        get: function() {
          var e = N(this.currentVal, "-", this.initialVal), o = et(this.zoom), r = N(N(e, "*", o), "-", e);
          return {
            x: e.x + r.x,
            y: e.y + r.y
          };
      ...
      function n(t) {
        var e = this, o = t.area, r = o === void 0 ? document : o, a = t.selectables, l = a === void 0 ? [] : a, c = t.autoScrollSpeed, d = c === void 0 ? 5 : c, g = t.overflowTolerance, h = g === void 0 ? {
          x: 25,
          y: 25
        } : g, S = t.zoom, x = S === void 0 ? 1 : S, I = t.customStyles, z = I === void 0 ? !1 : I, L = t.multiSelectMode, te = L === void 0 ? !1 : L, le = t.multiSelectToggling, Z = le === void 0 ? !0 : le, Me = t.multiSelectKeys, It = Me === void 0 ? ["Control", "Shift", "Meta"] : Me, Ee = t.selector, Tt = Ee === void 0 ? void 0 : Ee, Ae = t.draggability, pe = Ae === void 0 ? !0 : Ae, Ie = t.immediateDrag, Vt = Ie === void 0 ? !0 : Ie, Te = t.keyboardDrag, Lt = Te === void 0 ? !0 : Te, jt = t.dragKeys, Ve = t.keyboardDragSpeed, Ot = Ve === void 0 ? 10 : Ve, Le = t.useTransform, je = Le === void 0 ? !0 : Le, Oe = t.hoverClass, Ne = Oe === void 0 ? "ds-hover" : Oe, Ke = t.selectableClass, ze = Ke === void 0 ? "ds-selectable" : Ke, Be = t.selectedClass, Nt = Be === void 0 ? "ds-selected" : Be, Re = t.selectorClass, Kt = Re === void 0 ? "ds-selector" : Re, He = t.selectorAreaClass, zt = He === void 0 ? "ds-selector-area" : He, Bt = t.callback, Rt = t.onDragMove, Ht = t.onDragStartBegin, Ft = t.onDragStart, Ut = t.onElementSelect, Wt = t.onElementUnselect;
        ...
        }), s(this, "isMultiSelect", function(Yt) {
          return e.stores.KeyStore.isMultiSelectKeyPressed(Yt);
      ...
      return v(n, [{
        key: "_callbacksTemp",
        value: function(e) {
          var o = e.callback, r = e.onDragMove, a = e.onDragStart, l = e.onDragStartBegin, c = e.onElementSelect, d = e.onElementUnselect, g = function(S, x) {
            return console.warn("[DragSelect] ".concat(S, ' is deprecated. Use DragSelect.subscribe("').concat(x, '", (callbackObject) => {}) instead. Act Now! See docs for more info'));
          };
          o && (g("callback", "callback"), this.subscribe("callback", function(h) {
            ...
            h.items;
            var S = h.item, x = h.event;
            return c(S, x);
          })), d && (g("onElementUnselect", "elementunselect"), this.subscribe("elementunselect", function(h) {
            h.items;
            var S = h.item, x = h.event;
            return d(S, x);
          }));
...
const Lr = Xe.exports, jr = (y, f, u, m, v) => (f = Math, u = f.log, m = 1024, v = u(y) / u(m) | 0, y / f.pow(m, v)).toFixed(0) + " " + (v ? "KMGTPEZY"[--v] + "iB" : "B"), Or = (y, f = "en-US") => new Date(y * 1e3).toLocaleString(f), Nr = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5",
  viewBox: "0 0 20 20",
  ...
  setup(y) {
    return (f, u) => (w(), $("div", null, [
      y.direction == "down" ? (w(), $("svg", Nr, zr)) : W("", !0),
      y.direction == "up" ? (w(), $("svg", Br, Hr)) : W("", !0)
    ]));
  }
}), Ur = { class: "relative h-full" }, Wr = {
  key: 0,
  class: "grid grid-cols-12 border-b border-neutral-300 dark:border-gray-700 text-xs select-none"
}, Yr = /* @__PURE__ */ Se(" Name "), qr = /* @__PURE__ */ Se(" Size "), Zr = /* @__PURE__ */ Se(" Date "), Xr = ["onDblclick", "onContextmenu", "onDragstart", "onDragover", "onDrop", "data-type", "data-item", "data-index"], Jr = { class: "grid grid-cols-12 items-center" }, Gr = { class: "flex col-span-7 items-center" }, Qr = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  ...
  setup(y) {
    const f = y, u = inject("emitter"), m = (k) => k == null ? void 0 : k.substring(0, 3), v = (k) => k.replace(/((?=([\w\W]{0,14}))([\w\W]{8,})([\w\W]{8,}))/, "$2..$4"), s = j(null), D = j(null), _ = j(0), p = j(null), P = (k) => {
      k.type == "dir" ? u.emit("vf-fetch", { q: "index", adapter: f.data.adapter, path: k.path }) : u.emit("vf-modal-show", { type: "preview" });
    }, b = de({ active: !1, column: "", order: "" }), E = (k = !0) => {
      let M = [...f.data.files], C = b.column, F = b.order == "asc" ? 1 : -1;
      if (!k)
        return M;
      const V = (Y, q) => typeof Y == "string" && typeof q == "string" ? Y.toLowerCase().localeCompare(q.toLowerCase()) : Y < q ? -1 : Y > q ? 1 : 0;
      return b.active && (M = M.slice().sort((Y, q) => V(Y[C], q[C]) * F)), M;
    }, O = (k) => {
      b.active && b.column == k ? (b.active = b.order == "asc", b.column = k, b.order = "desc") : (b.active = !0, b.column = k, b.order = "asc");
    }, H = () => p.value.getSelection().map((k) => JSON.parse(k.dataset.item)), B = (k, M) => {
      if (k.altKey || k.ctrlKey || k.metaKey)
        return k.preventDefault(), !1;
      let C = D.value;
      k.dataTransfer.setDragImage(C, 0, 15), k.dataTransfer.effectAllowed = "all", k.dataTransfer.dropEffect = "copy";
    }, T = (k, M) => {
      k.preventDefault();
    }, G = (k, M) => {
      k.preventDefault(), (!M || M.type !== "dir" || p.value.getSelection().find((C) => C == k.currentTarget)) && (k.dataTransfer.dropEffect = "none", k.dataTransfer.effectAllowed = "none");
    };
    return he(() => {
      p.value = new Lr({
        area: s.value,
      ...
      }), u.on("vf-explorer-update", () => qe(() => {
        p.value.clearSelection(), p.value.setSelectables(document.getElementsByClassName("vf-item"));
      })), p.value.subscribe("predragstart", ({ isDragging: k }) => {
        k && (_.value = p.value.getSelection().length, p.value.break());
      }), p.value.subscribe("predragmove", ({ isDragging: k }) => {
        k && p.value.break();
      }), p.value.subscribe("callback", ({ items: k, event: M, isDragging: C }) => {
        u.emit("vf-nodes-selected", H()), _.value = p.value.getSelection().length;
      });
    }), he(() => {
      Ye(() => f.view, () => u.emit("vf-explorer-update"));
    }), (k, M) => (w(), $("div", Ur, [
      y.view == "list" ? (w(), $("div", Wr, [
        i("div", {
          onClick: M[0] || (M[0] = (C) => O("basename")),
          ...
          re(X(ue, {
            ...
            [be, b.active && b.column == "basename"]
          ])
        ]),
        i("div", {
          onClick: M[1] || (M[1] = (C) => O("file_size")),
          ...
          re(X(ue, {
            ...
            [be, b.active && b.column == "file_size"]
          ])
        ]),
        i("div", {
          onClick: M[2] || (M[2] = (C) => O("last_modified")),
          ...
          re(X(ue, {
            ...
            [be, b.active && b.column == "last_modified"]
          ])
        ])
      ])) : W("", !0),
      i("div", {
        ...
        ref: (C) => s.value = C,
        onContextmenu: M[3] || (M[3] = ce((C) => A(u).emit("vf-contextmenu-show", { event: C, area: s.value, items: H() }), ["self", "prevent"]))
      }, [
        y.view == "list" ? (w(!0), $(oe, { key: 0 }, se(E(), (C, F) => (w(), $("div", {
          draggable: "true",
          onDblclick: (V) => P(C),
          onContextmenu: ce((V) => A(u).emit("vf-contextmenu-show", { event: V, area: s.value, items: H(), target: C }), ["prevent"]),
          onDragstart: (V) => B(V),
          onDragover: (V) => G(V, C),
          onDrop: (V) => T(V),
          ...
          i("div", Jr, [
            i("div", Gr, [
              C.type == "dir" ? (w(), $("svg", Qr, tn)) : (w(), $("svg", rn, on)),
              i("span", sn, K(C.basename), 1)
            ]),
            i("div", an, K(C.file_size ? A(jr)(C.file_size) : ""), 1),
            i("div", ln, K(A(Or)(C.last_modified)), 1)
          ])
        ], 40, Xr))), 256)) : W("", !0),
        y.view == "grid" ? (w(!0), $(oe, { key: 1 }, se(E(!1), (C, F) => (w(), $("div", {
          draggable: "true",
          onDblclick: (V) => P(C),
          onContextmenu: ce((V) => A(u).emit("vf-contextmenu-show", { event: V, area: s.value, items: H(), target: C }), ["prevent"]),
          onDragstart: (V) => B(V),
          ...
          i("div", null, [
            i("div", un, [
              C.type == "dir" ? (w(), $("svg", dn, fn)) : (w(), $("svg", mn, vn)),
              i("div", pn, K(m(C.extension)), 1)
            ]),
            i("span", bn, K(v(C.basename)), 1)
          ])
        ], 40, cn))), 256)) : W("", !0),
        i("div", yn, [
          i("div", {
  ...
  setup(y) {
    const f = y, u = inject("emitter"), m = j(null), v = j([]);
    return u.on("vf-explorer-update", (s) => {
      var p;
      let D = [], _ = [];
      m.value = (p = f.data.dirname) != null ? p : "", m.value.length == 0 && (v.value = []), m.value.split("/").forEach(function(P) {
        D.push(P), D.join("/") != "" && _.push({
          basename: P,
          name: P,
          path: D.join("/"),
          type: "dir"
        });
      }), _.length > 4 && (_ = _.slice(-5), _[0].name = ".."), v.value = _;
    }), (s, D) => (w(), $("div", kn, [
      (w(), $("svg", {
        onClick: D[0] || (D[0] = (_) => {
          var p;
          return !v.value.length || A(u).emit("vf-fetch", { q: "index", adapter: y.data.adapter, path: (p = v.value[v.value.length - 2]) == null ? void 0 : p.path });
        }),
        xmlns: "http://www.w3.org/2000/svg",
        class: fe(["h-6 w-6 p-0.5 rounded", v.value.length ? "text-slate-700 hover:bg-neutral-300 dark:text-neutral-200 dark:hover:bg-gray-700 cursor-pointer" : "text-gray-400 dark:text-neutral-500"]),
        viewBox: "0 0 20 20",
        fill: "currentColor"
      }, Cn, 2)),
      i("div", Pn, [
        (w(), $("svg", {
          onClick: D[1] || (D[1] = (_) => A(u).emit("vf-fetch", { q: "index", adapter: y.data.adapter })),
        ...
        i("div", En, [
          (w(!0), $(oe, null, se(v.value, (_, p) => (w(), $("div", { key: p }, [
            An,
            i("span", {
              class: "px-1.5 py-1 text-slate-700 dark:text-slate-200 hover:bg-neutral-100 dark:hover:bg-gray-800 rounded cursor-pointer",
              title: _.basename,
              onClick: (P) => A(u).emit("vf-fetch", { q: "index", adapter: y.data.adapter, path: _.path })
            }, K(_.name), 9, In)
          ]))), 128))
        ])
      ])
...
}), Ln = /* @__PURE__ */ i("div", { class: "fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" }, null, -1), jn = { class: "fixed z-10 inset-0 overflow-y-auto" }, On = { class: "relative bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full" }, Nn = { class: "bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4" }, Kn = { class: "bg-gray-50 dark:bg-gray-800 dark:border-t dark:border-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse" }, zn = {
  name: "VFModal"
}, Bn = /* @__PURE__ */ Object.assign(zn, {
  setup(y) {
    ...
    return he(() => {
      ...
      class: "v-f-modal relative z-10",
      "aria-labelledby": "modal-title",
      role: "dialog",
      "aria-modal": "true",
      onKeyup: m[1] || (m[1] = _e((v) => A(f).emit("vf-modal-close"), ["esc"])),
      tabindex: "0"
    }, [
      Ln,
      i("div", jn, [
        i("div", {
          ...
          onClick: m[0] || (m[0] = ce((v) => A(f).emit("vf-modal-close"), ["self"]))
        }, [
          i("div", On, [
            i("div", Nn, [
              Ue(u.$slots, "default")
...
}), Rn = /* @__PURE__ */ i("div", { class: "sm:flex sm:items-start" }, [
    ...
    return (u, m) => {
      ...
      return w(), J(v, null, {
        buttons: R(() => [
          ...
          i("button", {
            type: "button",
            onClick: m[0] || (m[0] = (s) => A(f).emit("vf-modal-close")),
...
}), Wn = { class: "sm:flex sm:items-start" }, Yn = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-50 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    xmlns: "http://www.w3.org/2000/svg",
...
], -1), qn = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, Zn = {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, Xn = { class: "mt-2" }, Jn = { class: "text-sm text-gray-500" }, Gn = {
  name: "VFModalMessage"
        ...
        default: R(() => {
          ...
          return [
            i("div", Wn, [
              Yn,
              i("div", qn, [
                i("h3", Zn, K((D = (s = y.item) == null ? void 0 : s.title) != null ? D : "Title"), 1),
                i("div", Xn, [
                  i("p", Jn, K((p = (_ = y.item) == null ? void 0 : _.message) != null ? p : "Message") + ".", 1)
                ])
              ])
            ])
          ];
...
}), eo = { class: "sm:flex sm:items-start" }, to = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), ro = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, no = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "New Folder", -1), oo = { class: "mt-2" }, so = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, "Create a new folder", -1), io = ["onKeyup"], ao = {
  ...
  setup(y) {
    const f = y, u = inject("emitter"), { getStore: m } = inject("storage"), v = j(""), s = () => {
      v.value != "" && u.emit("vf-fetch", {
        q: "newfolder",
        adapter: m("adapter"),
    ...
    return (D, _) => {
      ...
      return w(), J(p, null, {
        buttons: R(() => [
          ...
          i("button", {
            type: "button",
            onClick: _[1] || (_[1] = (P) => A(u).emit("vf-modal-close")),
            class: "mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          }, "Cancel")
        ]),
        default: R(() => [
...
}), co = /* @__PURE__ */ i("div", { class: "sm:flex sm:items-start" }, [
  /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
    /* @__PURE__ */ i("svg", {
      class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
      xmlns: "http://www.w3.org/2000/svg",
...
}), mo = { class: "sm:flex sm:items-start" }, go = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), vo = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, po = {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, bo = { class: "mt-2" }, yo = { class: "flex text-sm text-gray-800 dark:text-gray-400 py-2" }, So = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  ko
], Co = { class: "ml-1.5" }, Po = ["onKeyup"], $o = {
  name: "VFModalRename"
}, Mo = /* @__PURE__ */ Object.assign($o, {
  props: {
    selection: Object,
    current: Object
  },
  setup(y) {
    const f = y, u = inject("emitter"), { getStore: m } = inject("storage"), v = j(f.selection.items[0]), s = j(f.selection.items[0].basename), D = () => {
      ...
      return w(), J(P, null, {
        ...
        default: R(() => [
          i("div", mo, [
            go,
            i("div", vo, [
              i("h3", po, "Rename your " + K(v.value.type == "dir" ? "folder" : "file"), 1),
              i("div", bo, [
                i("p", yo, [
                  v.value.type == "dir" ? (w(), $("svg", So, wo)) : (w(), $("svg", xo, Do)),
                  i("span", Co, K(v.value.basename), 1)
                ]),
                re(i("input", {
...
], -1), Ao = /* @__PURE__ */ i("button", {
  type: "button",
  class: "w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm"
}, "Yes, delete!", -1), Io = {
  name: "VFModalUpload"
}, To = /* @__PURE__ */ Object.assign(Io, {
  setup(y) {
    const f = inject("emitter");
    return (u, m) => {
      const v = U("v-f-modal");
...
}), Vo = ["onClick"], Lo = /* @__PURE__ */ i("span", { class: "px-1" }, null, -1), jo = {
  name: "VFContextMenu"
}, Oo = /* @__PURE__ */ Object.assign(jo, {
  setup(y) {
    const f = inject("emitter"), u = j(null), m = de({
      active: !1,
      items: [],
      positions: {
        left: 0,
    ...
    const s = {
      newfolder: {
        title: "New Folder",
        action: () => {
          f.emit("vf-modal-show", { type: "new-folder" });
        }
      },
      delete: {
        title: "Delete",
        action: () => {
          f.emit("vf-modal-show", { type: "delete" });
        }
      },
      preview: {
        title: "Preview",
        action: () => {
          f.emit("vf-modal-show", { type: "preview" });
        }
      },
      zip: {
        title: "Zip",
      ...
      rename: {
        title: "Rename",
        action: () => {
          f.emit("vf-modal-show", { type: "rename", items: v });
        }
      }
    }, D = (p) => {
      f.emit("vf-contextmenu-hide"), p.action();
    };
    f.on("vf-contextmenu-show", ({ event: p, area: P, items: b, target: E = null }) => {
      m.items = [], E ? b.length > 1 && b.some((O) => O.path === E.path) ? (m.items.push(s.zip), m.items.push(s.delete), f.emit("vf-context-selected", b), console.log(b.length + " selected (more than 1 item.)")) : (m.items.push(s.preview), m.items.push(s.rename), m.items.push(s.zip), m.items.push(s.delete), f.emit("vf-context-selected", [E]), console.log(E.type + " is selected")) : (m.items.push(s.newfolder), f.emit("vf-context-selected", []), console.log("no files selected")), _(p, P);
    }), f.on("vf-contextmenu-hide", () => {
      m.active = !1;
    });
    const _ = (p, P) => {
      m.active = !0, qe(() => {
        let b = P.getBoundingClientRect(), E = p.pageX - window.scrollX, O = p.pageY - window.scrollY, H = u.value.offsetHeight, B = u.value.offsetWidth;
        E = b.right - p.pageX + window.scrollX < B ? E - B : E, O = b.bottom - p.pageY + window.scrollY < H ? O - H : O, m.positions = {
          left: E + "px",
          top: O + "px"
        };
      });
    };
    return (p, P) => m.active ? (w(), $("ul", {
      key: 0,
      ...
      ref: (b) => u.value = b,
      style: Jt(m.positions)
    }, [
      (w(!0), $(oe, null, se(m.items, (b) => (w(), $("li", {
        class: "px-2 py-1.5 cursor-pointer hover:bg-neutral-200 dark:hover:bg-gray-700",
        key: b.title,
        onClick: (E) => D(b)
      }, [
        Lo,
        i("span", null, K(b.title), 1)
      ], 8, Vo))), 128))
    ], 4)) : W("", !0);
  }
}), ye = {
...
const Ko = {
  install(y) {
    for (const f in ye)
      if (ye.hasOwnProperty(f)) {
        const u = ye[f];
        y.component(u.name, u);
      }
  }
};
export {
