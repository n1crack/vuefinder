...
const er = {
  ...
  setup(p) {
    const h = p, a = Qt();
    qe("emitter", a);
    const { setStore: _, getStore: d } = Ye(h.id);
    qe("storage", Ye(h.id));
    const o = he({ adapter: "local", storages: [], dirname: ".", files: [] }), D = I(d("viewport", "grid")), b = I(d("darkMode", h.dark));
    a.on("vf-darkMode-toggle", () => {
      b.value = !b.value, _("darkMode", b.value);
    }), a.on("vf-view-toggle", (w) => {
      D.value = w;
    });
    const y = he({
      active: !1,
    ...
    a.on("vf-modal-close", () => {
      y.active = !1;
    }), a.on("vf-modal-show", (w) => {
      y.active = !0, y.type = w.type, y.data = w;
    });
    const g = (w) => {
      Object.assign(o, w), a.emit("vf-nodes-selected", {}), a.emit("vf-explorer-update", w);
    };
    return a.on("vf-fetch", (w) => {
      Gt(h.url, { params: w }).then((S) => {
        a.emit("vf-modal-close"), g(S);
      });
    }), fe(() => {
      a.emit("vf-fetch", { q: "index", adapter: d("adapter", o.adapter) });
    }), (w, S) => {
      const A = R("v-f-toolbar"), B = R("v-f-breadcrumb"), K = R("v-f-explorer"), E = R("v-f-statusbar"), te = R("v-f-context-menu");
      return x(), P("div", {
        class: ae(b.value ? "dark" : "")
      }, [
        i("div", {
          ...
          onMousedown: S[0] || (S[0] = (re) => j(a).emit("vf-contextmenu-hide"))
        }, [
          X(A),
          ...
          X(E, { data: o }, null, 8, ["data"])
        ], 32),
        y.active ? (x(), q(Yt("v-f-modal-" + y.type), {
          key: 0,
          selection: y.data,
          current: o
  ...
  setup(p) {
    const h = inject("emitter"), { getStore: a, setStore: _ } = inject("storage"), d = I(a("viewport", "grid")), o = I([]);
    return h.on("vf-nodes-selected", (D) => {
      o.value = D;
    }), h.on("vf-view-toggle", (D) => {
      _("viewport", D), d.value = D;
    }), (D, b) => (x(), P("div", rr, [
      i("div", nr, [
        i("div", {
          class: "mx-1.5",
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[0] || (b[0] = (y) => j(h).emit("vf-modal-show", { type: "new-folder", items: o.value }))
        }, sr),
        i("div", {
          class: "mx-1.5",
          "aria-label": "New File",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[1] || (b[1] = (y) => j(h).emit("vf-modal-show", { type: "new-file", items: o.value }))
        }, ar),
        i("div", {
          class: "mx-1.5",
          "aria-label": "Rename",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[2] || (b[2] = (y) => o.value.length != 1 || j(h).emit("vf-modal-show", { type: "rename", items: o.value }))
        }, [
          (x(), P("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: ae([o.value.length == 1 ? "cursor-pointer stroke-gray-800 hover:stroke-cyan-700 dark:stroke-gray-300 dark:hover:stroke-gray-100" : "stroke-gray-200  dark:stroke-gray-600", "h-6 w-6 md:h-8 md:w-8 m-auto"]),
            fill: "none",
            viewBox: "0 0 24 24",
            stroke: "none",
            "stroke-width": "1.5"
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[3] || (b[3] = (y) => !o.value.length || j(h).emit("vf-modal-show", { type: "delete", items: o.value }))
        }, [
          (x(), P("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: ae([o.value.length ? "cursor-pointer stroke-gray-800 hover:stroke-cyan-700 dark:stroke-gray-300 dark:hover:stroke-gray-100" : "stroke-gray-200  dark:stroke-gray-600", "h-6 w-6 md:h-8 md:w-8 m-auto"]),
            fill: "none",
            viewBox: "0 0 24 24",
            stroke: "none",
            "stroke-width": "1.5"
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[4] || (b[4] = (y) => j(h).emit("vf-modal-show", { type: "upload", items: o.value }))
        }, hr),
        i("div", {
          class: "mx-1.5",
          "aria-label": "Archive",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[5] || (b[5] = (y) => !o.value.length || j(h).emit("vf-modal-show", { type: "archive", items: o.value }))
        }, [
          (x(), P("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: ae([o.value.length ? "cursor-pointer stroke-gray-800 hover:stroke-cyan-700 dark:stroke-gray-300 dark:hover:stroke-gray-100" : "stroke-gray-200  dark:stroke-gray-600", "h-6 w-6 md:h-8 md:w-8 m-auto"]),
      ...
      i("div", vr, [
        i("div", pr, [
          (x(), P("svg", {
            onClick: b[6] || (b[6] = (y) => j(h).emit("vf-darkMode-toggle")),
            viewBox: "0 0 24 24",
            "stroke-width": "2",
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[7] || (b[7] = (y) => j(h).emit("vf-view-toggle", d.value == "list" ? "grid" : "list"))
        }, [
          d.value == "grid" ? (x(), P("svg", _r, wr)) : W("", !0),
          d.value == "list" ? (x(), P("svg", xr, Dr)) : W("", !0)
        ])
      ])
    ]));
  }
}), Pr = { class: "p-1 text-xs border-t border-neutral-300 dark:border-gray-700/50 flex justify-between select-none" }, Mr = { class: "flex leading-5 items-center" }, jr = /* @__PURE__ */ i("div", {
  class: "mx-2",
  "aria-label": "Storage",
...
], -1), Ar = ["value"], Er = { class: "ml-3" }, Tr = { class: "flex leading-5 items-center" }, Ir = /* @__PURE__ */ i("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  ...
  setup(p) {
    var y;
    const h = p, a = inject("emitter"), { getStore: _, setStore: d } = inject("storage"), o = I(0), D = I((y = _("adapter")) != null ? y : h.data.adapter), b = () => {
      a.emit("vf-fetch", { q: "index", adapter: D.value }), d("adapter", D.value);
    };
    return a.on("vf-nodes-selected", (g) => {
      o.value = g.length;
    }), (g, w) => (x(), P("div", Pr, [
      i("div", Mr, [
        jr,
        G(i("select", {
          ...
          (x(!0), P(Q, null, ee(p.data.storages, (S) => (x(), P("option", { value: S }, N(S), 9, Ar))), 256))
        ], 544), [
          [Zt, D.value]
        ]),
        i("span", Er, N(o.value > 0 ? o.value + " items selected." : ""), 1)
      ]),
      i("div", Tr, [
        i("span", {
          onClick: w[1] || (w[1] = (S) => j(a).emit("vf-modal-show", { type: "message", title: "Vuefinder 1.0", message: "Vuefinder is a file manager component for vue 3." }))
        }, Vr)
      ])
    ]));
  }
});
var Nr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xe = { exports: {} };
(function(p, h) {
  (function(a, _) {
    p.exports = _();
  })(Nr, function() {
    ...
    function b(n) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2 ? D(Object(e), !0).forEach(function(s) {
          o(n, s, e[s]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(e)) : D(Object(e)).forEach(function(s) {
    ...
    function w(n, t) {
      return w = Object.setPrototypeOf || function(s, r) {
    ...
    function A(n, t, e) {
      return S() ? A = Reflect.construct : A = function(r, l, c) {
        var u = [null];
        u.push.apply(u, l);
        var m = Function.bind.apply(r, u), v = new m();
        return c && w(v, c.prototype), v;
    ...
    function K(n) {
      ...
      return K = function(s) {
        ...
        function r() {
          return A(s, arguments, g(this).constructor);
        }
    ...
    function te(n, t) {
      return t && (typeof t == "object" || typeof t == "function") ? t : E(n);
    }
    function re(n) {
      var t = S();
      return function() {
    ...
    function xe(n, t) {
      for (; !Object.prototype.hasOwnProperty.call(n, t) && (n = g(n), n !== null); )
        ;
      return n;
    }
    function $(n, t, e) {
      return typeof Reflect < "u" && Reflect.get ? $ = Reflect.get : $ = function(r, l, c) {
        var u = xe(r, l);
        if (!!u) {
          var m = Object.getOwnPropertyDescriptor(u, l);
          return m.get ? m.get.call(c) : m.value;
        }
      }, $(n, t, e || n);
    }
    function T(n, t) {
      return L(n) || J(n, t) || ke(n, t) || Qe();
    }
    function C(n) {
      return U(n) || Y(n) || ke(n) || Ge();
    }
    function U(n) {
      if (Array.isArray(n))
        return ve(n);
    ...
    function J(n, t) {
      if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(n)))) {
        ...
        try {
          for (var c = n[Symbol.iterator](), u; !(s = (u = c.next()).done) && (e.push(u.value), !(t && e.length === t)); s = !0)
            ;
        } catch (m) {
          r = !0, l = m;
        } finally {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var H = function(t, e, s) {
      ...
      if (s.transform.indexOf("3d") >= 0) {
        ...
        var u = s.transform.trim().match(/matrix\((.*?)\)/);
        if (u && u.length) {
          var m, v = (m = u[1]) === null || m === void 0 ? void 0 : m.split(",");
      ...
      var t = n.shiftKey, e = n.keyboardDragSpeed, s = n.zoom, r = n.key, l = n.dragKeys, c = n.scrollDiff, u = n.canScroll, m = n.scrollCallback, v = {
        x: 0,
        y: 0
      }, f = t ? e * 4 * s : e * s;
      return l.left.includes(r) && (v.x = c.x || -f, !t && !c.x && u && m(["left"], e)), l.right.includes(r) && (v.x = c.x || f, !t && !c.x && u && m(["right"], e)), l.up.includes(r) && (v.y = c.y || -f, !t && !c.y && u && m(["top"], e)), l.down.includes(r) && (v.y = c.y || f, !t && !c.y && u && m(["bottom"], e)), v;
    }, ft = function(n) {
      ...
      if (!t.classList.contains(l) && !e)
        return !1;
      var c = s.has(t), u = r.has(t);
      c && !u ? s.delete(t) : !c && u && s.add(t), t.classList.remove(l);
    }, be = function(n, t) {
      return n.left < t.right && n.right > t.left && n.top < t.bottom && n.bottom > t.top;
    }, Me = function(n) {
      var t = n.element, e = n.posDirection, s = n.containerRect, r = n.useTransform, l = dt(t, r), c = H(l, "+", e);
      ie(t, c, r);
      var u = t.getBoundingClientRect(), m = $e({
        elementRect: u,
        containerRect: s
      });
      mt({
      ...
      if (!!t.length) {
        var s = document && document.documentElement && document.documentElement.scrollTop && document.documentElement, r = n instanceof HTMLDocument ? s || document.body : n, l = t.includes("top") && r.scrollTop > 0, c = t.includes("bottom") && r.scrollTop < r.scrollHeight, u = t.includes("left") && r.scrollLeft > 0, m = t.includes("right") && r.scrollLeft < r.scrollWidth;
        l && (r.scrollTop -= 1 * e), c && (r.scrollTop += 1 * e), u && (r.scrollLeft -= 1 * e), m && (r.scrollLeft += 1 * e);
      }
    }, ie = function(n, t, e) {
      if (e) {
      ...
      for (var t = n.subscribe, e = n.publish, s = n.Interaction, r = n.SelectedSet, l = {
        ...
        var f = T(m[u], 2), k = f[0], M = f[1];
        ["pre", !1].forEach(function(V) {
          return t(V ? "".concat(k, ":").concat(V) : k, function(F) {
            return M.forEach(function(O) {
              return (!O.condition || O.condition(F)) && e(V ? "".concat(V).concat(O.name) : O.name, b({
                items: r.elements,
      ...
      }, u = 0, m = Object.entries(l); u < m.length; u++)
        c();
    }, oe = function(n) {
      return n ? !Array.isArray(n) && (n instanceof HTMLElement || n instanceof SVGElement) ? [n] : C(n) : [];
    }, je = function(n, t) {
      ...
      function n(t) {
        ...
        }), o(this, "scroll", function(c, u) {
          var m = {
            scroll_directions: c,
            scroll_multiplier: u
          };
          e.PubSub.publish("Area:scroll:pre", m), pt(e._node, c, u), e.PubSub.publish("Area:scroll", m);
        }), this._zoom = l, this.PubSub = r, this.setArea(s), this._modificationCallback = st(function(c) {
          e.PubSub.publish("Area:modified:pre", {
            event: c,
            item: e
          }), e.reset(), e.PubSub.publish("Area:modified", {
      ...
      return d(n, [{
        ...
        key: "rect",
        get: function() {
          return this._rect ? this._rect : this._rect = it(this.HTMLNode, this._zoom);
        }
      }, {
        key: "parentNodes",
        get: function() {
      ...
      function n(t) {
        var e = this, s = t.DS, r = t.dragKeys, l = t.draggability, c = t.keyboardDrag, u = t.keyboardDragSpeed, m = t.useTransform, v = t.zoom;
        a(this, n), o(this, "_useTransform", void 0), o(this, "_prevCursorPos", void 0), o(this, "_prevScrollPos", void 0), o(this, "_elements", []), o(this, "_draggability", void 0), o(this, "_dragKeys", void 0), o(this, "_dragKeysFlat", void 0), o(this, "_keyboardDrag", void 0), o(this, "_keyboardDragSpeed", void 0), o(this, "_zoom", void 0), o(this, "keyboardDrag", function(f) {
          ...
          if (!(!e._keyboardDrag || !e._dragKeysFlat.includes(M) || !e.DS.SelectedSet.size || !e._draggability || e.DS.continue)) {
            ...
            e._elements.forEach(function(O) {
              return Me({
                element: O,
                posDirection: F,
          ...
          var k = f.isDragging, M = f.isDraggingKeyboard;
          !k || M || (e._prevCursorPos = null, e._prevScrollPos = null, e._elements = e.DS.getSelection(), e.handleZIndex(!0));
          ...
          var k = f.isDragging, M = f.isDraggingKeyboard;
          if (!(!k || !e._elements.length || M || e.DS.continue)) {
            var V = H(e._cursorDiff, "+", e._scrollDiff);
          ...
          e._elements.forEach(function(k) {
            return k.style.zIndex = "".concat((parseInt(k.style.zIndex) || 0) + f ? 9999 : -9998);
          });
        }), this.DS = s, this._useTransform = m, this._keyboardDragSpeed = u, this._keyboardDrag = c, this._zoom = v, this._draggability = l, this._dragKeys = {
        ...
        }, this._dragKeysFlat = [].concat(C(this._dragKeys.up), C(this._dragKeys.down), C(this._dragKeys.left), C(this._dragKeys.right)), this.DS.subscribe("Interaction:start", this.start), this.DS.subscribe("Interaction:end", this.stop), this.DS.subscribe("Interaction:update", this.update), this.DS.subscribe("KeyStore:down", this.keyboardDrag), this.DS.subscribe("KeyStore:up", this.keyboardEnd);
      }
      return d(n, [{
        key: "_cursorDiff",
        get: function() {
      ...
      function n(t) {
        var e = this, s = t.DS, r = t.areaElement, l = t.draggability, c = t.immediateDrag, u = t.selectableClass;
        a(this, n), o(this, "_areaElement", void 0), o(this, "_draggability", void 0), o(this, "_immediateDrag", void 0), o(this, "_selectableClass", void 0), o(this, "isInteracting", void 0), o(this, "isDragging", void 0), o(this, "init", function() {
          ...
          var v = m.target.closest(".".concat(e._selectableClass));
          return !e._draggability || e.DS.stores.KeyStore.isMultiSelectKeyPressed(m) || !v ? !1 : (e._immediateDrag && (e.DS.SelectedSet.size ? e.DS.SelectedSet.has(v) || (e.DS.SelectedSet.clear(), e.DS.SelectedSet.add(
            v
          ...
          if (!!e._canInteract(v) && !(v.detail > 0)) {
            var f = e.DS, k = f.stores, M = k.PointerStore, V = k.KeyStore, F = f.SelectableSet, O = f.SelectedSet;
            M.start(v);
            var se = v.target;
            !F.has(se) || (V.isMultiSelectKeyPressed(v) || O.clear(), O.toggle(se), e.reset());
          }
        }), o(this, "stop", function() {
          ...
          var v = m.event, f = m.scroll_directions, k = m.scroll_multiplier;
        ...
        }), this._areaElement = r, this._draggability = l, this._immediateDrag = c, this._selectableClass = u, this.DS = s, this.DS.subscribe("PointerStore:updated", this.update), this.DS.subscribe("Selectable:click", this.onClick), this.DS.subscribe("Selectable:pointer", function(m) {
          var v = m.event;
          return e.start(v);
      ...
      var t = re(e);
      function e(s) {
        var r, l = s.elements, c = s.className, u = s.hoverClassName, m = s.draggability, v = s.useTransform, f = s.DS;
        return a(this, e), r = t.call(this), o(E(r), "_initElements", void 0), o(E(r), "_className", void 0), o(E(r), "_hoverClassName", void 0), o(E(r), "_useTransform", void 0), o(E(r), "_draggability", void 0), o(E(r), "init", function() {
          return r._initElements.forEach(function(k) {
            return r.add(k);
          });
        }), o(E(r), "clear", function() {
          return r.forEach(function(k) {
            return r.delete(k);
          });
        }), o(E(r), "_onClick", function(k) {
          return r.DS.publish(["Selectable:click:pre", "Selectable:click"], {
            event: k
          });
        }), o(E(r), "_onPointer", function(k) {
          return r.DS.publish(["Selectable:pointer:pre", "Selectable:pointer"], {
            event: k
          });
        }), o(E(r), "addAll", function(k) {
          return k.forEach(function(M) {
            return r.add(M);
          });
        }), o(E(r), "deleteAll", function(k) {
          return k.forEach(function(M) {
            return r.delete(M);
          });
        }), r.DS = f, r._initElements = oe(l), r._className = c, r._hoverClassName = u, r._useTransform = v, r._draggability = m, r.DS.subscribe("Interaction:init", r.init), r;
      }
      return d(e, [{
        key: "add",
        value: function(r) {
          return r.classList.add(this._className), r.addEventListener("click", this._onClick), r.addEventListener("mousedown", this._onPointer), r.addEventListener("touchstart", this._onPointer, {
            passive: !1
          }), this._draggability && !this._useTransform && Pe({
            computedStyle: window.getComputedStyle(r),
            node: r
          }), $(g(e.prototype), "add", this).call(this, r);
        }
      }, {
        key: "delete",
        value: function(r) {
          return r.classList.remove(this._className), r.classList.remove(this._hoverClassName), r.removeEventListener("click", this._onClick), r.removeEventListener("mousedown", this._onPointer), r.removeEventListener("touchstart", this._onPointer, {
            passive: !1
          }), $(g(e.prototype), "delete", this).call(this, r);
        }
      }, {
        key: "elements",
        get: function() {
    ...
    }(/* @__PURE__ */ K(Set)), kt = /* @__PURE__ */ function(n) {
      y(e, n);
      var t = re(e);
      function e(s) {
        var r, l = s.className, c = s.DS;
        return a(this, e), r = t.call(this), o(E(r), "_className", void 0), o(E(r), "clear", function() {
          return r.forEach(function(u) {
            return r.delete(u);
          });
        }), o(E(r), "addAll", function(u) {
          return u.forEach(function(m) {
            return r.add(m);
          });
        }), o(E(r), "deleteAll", function(u) {
          return u.forEach(function(m) {
            return r.delete(m);
          });
      ...
      return d(e, [{
        key: "add",
        value: function(r) {
          if (!$(g(e.prototype), "has", this).call(this, r)) {
            var l = {
              items: this.elements,
              item: r
            };
            return this.DS.publish("Selected:added:pre", l), $(g(e.prototype), "add", this).call(this, r), r.classList.add(this._className), r.style.zIndex = "".concat((parseInt(r.style.zIndex) || 0) + 1), this.DS.publish("Selected:added", l), this;
          }
        }
      }, {
        key: "delete",
        value: function(r) {
          if (!!$(g(e.prototype), "has", this).call(this, r)) {
            ...
            var c = $(g(e.prototype), "delete", this).call(this, r);
    ...
    }(/* @__PURE__ */ K(Set)), Dt = /* @__PURE__ */ function() {
      function n(t) {
        ...
        a(this, n), o(this, "_prevSelectedSet", void 0), o(this, "_hoverClassName", void 0), o(this, "_multiSelectToggling", void 0), o(this, "start", function(c) {
          var u = c.event, m = c.isDragging;
          m || (e._storePrevious(u), e._handleInsideSelection(!0, u));
        }), o(this, "update", function(c) {
          var u = c.isDragging;
          u || e.DS.continue || e._handleInsideSelection();
        }), o(this, "_handleInsideSelection", function(c, u) {
          for (var m = e.DS, v = m.SelectableSet, f = m.SelectorArea, k = m.Selector, M = v.elements.map(function(Z) {
            return [Z, Z.getBoundingClientRect()];
          }), V = [], F = [], O = 0, se = M.length; O < se; O++)
            !f.isInside(M[O][0], M[O][1]) || (be(M[O][1], k.rect) ? V.push(M[O][0]) : F.push(M[O][0]));
          var ue = e.DS.stores.KeyStore.isMultiSelectKeyPressed(u) && e._multiSelectToggling;
          e.DS.continue || (V.forEach(function(Z) {
            return ft({
              element: Z,
              force: c,
              multiSelectionToggle: ue,
      ...
      function n(t) {
        ...
        a(this, n), o(this, "_rect", void 0), o(this, "start", function(u) {
          var m = u.isDragging;
          if (!m) {
            var v = e.DS.stores.PointerStore, f = v.initialValArea;
        ...
        }), o(this, "update", function(u) {
          var m = u.isDragging;
          if (!(m || e.DS.continue)) {
            var v = e.DS.stores, f = v.ScrollStore, k = v.PointerStore, M = lt({
              scrollAmount: f.scrollAmount,
              initialPointerPos: k.initialValArea,
              pointerPos: k.currentValArea
            });
            je(e.HTMLNode, M), e._rect = null;
          }
        }), this.DS = s, this.HTMLNode = r || ot(c), this.HTMLNode.classList.add(l), this.DS.subscribe("Interaction:start", this.start), this.DS.subscribe("Interaction:update", this.update), this.DS.subscribe("Interaction:end", this.stop);
      }
      return d(n, [{
        key: "rect",
        get: function() {
      ...
      function n(t) {
        ...
        a(this, n), o(this, "_autoScrollSpeed", void 0), o(this, "_scrollInterval", void 0), o(this, "_rect", void 0), o(this, "currentEdges", []), o(this, "_overflowTolerance", void 0), o(this, "start", function() {
          ...
          var u = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "append", m = document.body ? "body" : "documentElement", v = "".concat(u, "Child");
          e.HTMLNode[v](e.DS.Selector.HTMLNode), document[m][v](e.HTMLNode);
        }), o(this, "updatePos", function() {
          e._rect = null;
          var u = e.DS.Area.rect, m = e.DS.Area.computedBorder, v = e.HTMLNode.style, f = "".concat(u.top + m.top, "px"), k = "".concat(u.left + m.left, "px"), M = "".concat(u.width, "px"), V = "".concat(u.height, "px");
          v.top !== f && (v.top = f), v.left !== k && (v.left = k), v.width !== M && (v.width = M), v.height !== V && (v.height = V);
        }), o(this, "stop", function(u) {
          ...
          if (!e.DS.continue) {
            var u = e.DS, m = u.stores.PointerStore, v = u.Area;
            e.currentEdges = $e({
        ...
        }), o(this, "isInside", function(u, m) {
          return e.DS.Area.HTMLNode.contains(u) && e.DS.stores.ScrollStore.canScroll ? !0 : be(e.rect, m || u.getBoundingClientRect());
        }), this._autoScrollSpeed = l, this._overflowTolerance = c, this.DS = s, this.HTMLNode = nt(r), this.DS.subscribe("Area:modified", this.updatePos), this.DS.subscribe("Interaction:init", this.start), this.DS.subscribe("Interaction:start", this.startAutoScroll), this.DS.subscribe("Interaction:end", function() {
      ...
      function n(t) {
        ...
        a(this, n), o(this, "_initialVal", void 0), o(this, "_currentVal", void 0), o(this, "_areaElement", void 0), o(this, "_canScroll", void 0), o(this, "init", function() {
          ...
          e._currentVal = e._initialVal = ce(e._areaElement), e._areaElement.addEventListener("scroll", e.update);
        }), o(this, "update", function() {
          return e._currentVal = ce(e._areaElement);
        }), o(this, "stop", function() {
      ...
      return d(n, [{
        ...
        key: "scrollAmount",
        get: function() {
          var e = H(this.currentVal, "-", this.initialVal), s = et(this.zoom), r = H(H(e, "*", s), "-", e);
          return {
            x: e.x + r.x,
            y: e.y + r.y
          };
        ...
        key: "currentVal",
        get: function() {
          return this._currentVal || (this._currentVal = ce(this._areaElement)), this._currentVal;
        }
      }]), n;
    }(), At = /* @__PURE__ */ function() {
      function n(t) {
        var e = this, s = t.area, r = s === void 0 ? document : s, l = t.selectables, c = l === void 0 ? [] : l, u = t.autoScrollSpeed, m = u === void 0 ? 5 : u, v = t.overflowTolerance, f = v === void 0 ? {
          x: 25,
          y: 25
        } : v, k = t.zoom, M = k === void 0 ? 1 : k, V = t.customStyles, F = V === void 0 ? !1 : V, O = t.multiSelectMode, se = O === void 0 ? !1 : O, ue = t.multiSelectToggling, Z = ue === void 0 ? !0 : ue, Ae = t.multiSelectKeys, Et = Ae === void 0 ? ["Control", "Shift", "Meta"] : Ae, Ee = t.selector, Tt = Ee === void 0 ? void 0 : Ee, Te = t.draggability, ye = Te === void 0 ? !0 : Te, Ie = t.immediateDrag, It = Ie === void 0 ? !0 : Ie, Ve = t.keyboardDrag, Vt = Ve === void 0 ? !0 : Ve, Lt = t.dragKeys, Le = t.keyboardDragSpeed, Ot = Le === void 0 ? 10 : Le, Oe = t.useTransform, Ne = Oe === void 0 ? !0 : Oe, ze = t.hoverClass, Ke = ze === void 0 ? "ds-hover" : ze, Be = t.selectableClass, He = Be === void 0 ? "ds-selectable" : Be, Re = t.selectedClass, Nt = Re === void 0 ? "ds-selected" : Re, Fe = t.selectorClass, zt = Fe === void 0 ? "ds-selector" : Fe, Ue = t.selectorAreaClass, Kt = Ue === void 0 ? "ds-selector-area" : Ue, Bt = t.callback, Ht = t.onDragMove, Rt = t.onDragStartBegin, Ft = t.onDragStart, Ut = t.onElementSelect, qt = t.onElementUnselect;
        ...
        }), o(this, "isMultiSelect", function(Wt) {
      ...
      return d(n, [{
        key: "_callbacksTemp",
        value: function(e) {
          var s = e.callback, r = e.onDragMove, l = e.onDragStart, c = e.onDragStartBegin, u = e.onElementSelect, m = e.onElementUnselect, v = function(k, M) {
            return console.warn("[DragSelect] ".concat(k, ' is deprecated. Use DragSelect.subscribe("').concat(M, '", (callbackObject) => {}) instead. Act Now! See docs for more info'));
          };
          s && (v("callback", "callback"), this.subscribe("callback", function(f) {
            var k = f.items;
            f.item;
            var M = f.event;
            return s(k, M);
          })), r && (v("onDragMove", "dragmove"), this.subscribe("dragmove", function(f) {
            f.items, f.item;
            var k = f.event;
            return r(k);
          })), l && (v("onDragStart", "dragstart"), this.subscribe("dragstart", function(f) {
            f.items, f.item;
            var k = f.event;
            return l(k);
          })), c && (v("onDragStartBegin", "dragstart"), this.subscribe("dragstart", function(f) {
            f.items, f.item;
            var k = f.event;
            return c(k);
          })), u && (v("onElementSelect", "elementselect"), this.subscribe("elementselect", function(f) {
            f.items;
            var k = f.item, M = f.event;
            return u(k, M);
          })), m && (v("onElementUnselect", "elementunselect"), this.subscribe("elementunselect", function(f) {
            f.items;
            var k = f.item, M = f.event;
            return m(k, M);
          }));
...
const zr = Xe.exports, Kr = (p, h, a, _, d) => (h = Math, a = h.log, _ = 1024, d = a(p) / a(_) | 0, p / h.pow(_, d)).toFixed(0) + " " + (d ? "KMGTPEZY"[--d] + "iB" : "B"), Br = (p, h = "en-US") => new Date(p * 1e3).toLocaleString(h), Hr = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5",
  viewBox: "0 0 20 20",
  ...
  name: "VFSortIcon"
}, me = /* @__PURE__ */ Object.assign(Yr, {
  props: { direction: String },
  setup(p) {
    return (h, a) => (x(), P("div", null, [
      p.direction == "down" ? (x(), P("svg", Hr, Fr)) : W("", !0),
      p.direction == "up" ? (x(), P("svg", Ur, Wr)) : W("", !0)
    ]));
  }
  ...
  yn
], Sn = { class: "absolute hidden md:block top-1/2 w-full text-center text-neutral-500" }, wn = { class: "break-all" }, xn = { class: "absolute top-[-200px] left-[-200px]" }, kn = /* @__PURE__ */ i("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  ...
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = ($) => $ == null ? void 0 : $.substring(0, 3), o = ($) => $.replace(/((?=([\w\W]{0,14}))([\w\W]{8,})([\w\W]{8,}))/, "$2..$4"), D = I(null), b = I(null), y = I(0), g = I(null), w = ($) => {
    ...
    }, S = he({ active: !1, column: "", order: "" }), A = ($ = !0) => {
      let T = [...h.data.files], C = S.column, U = S.order == "asc" ? 1 : -1;
      if (!$)
        return T;
      const L = (Y, J) => typeof Y == "string" && typeof J == "string" ? Y.toLowerCase().localeCompare(J.toLowerCase()) : Y < J ? -1 : Y > J ? 1 : 0;
      return S.active && (T = T.slice().sort((Y, J) => L(Y[C], J[C]) * U)), T;
    }, B = ($) => {
      S.active && S.column == $ ? (S.active = S.order == "asc", S.column = $, S.order = "desc") : (S.active = !0, S.column = $, S.order = "asc");
    }, K = () => g.value.getSelection().map(($) => JSON.parse($.dataset.item)), E = ($, T) => {
      if ($.altKey || $.ctrlKey || $.metaKey)
        return $.preventDefault(), !1;
      let C = b.value;
      $.dataTransfer.setDragImage(C, 0, 15), $.dataTransfer.effectAllowed = "all", $.dataTransfer.dropEffect = "copy", $.dataTransfer.setData("items", JSON.stringify(K()));
    }, te = ($, T) => {
      $.preventDefault();
      let C = JSON.parse($.dataTransfer.getData("items"));
      if (C.find((U) => U.storage != _("adapter"))) {
        alert("Moving items between different storages is not supported yet.");
        return;
      }
      a.emit("vf-modal-show", { type: "move", items: { from: C, to: T } });
    }, re = ($, T) => {
      $.preventDefault(), (!T || T.type !== "dir" || g.value.getSelection().find((C) => C == $.currentTarget)) && ($.dataTransfer.dropEffect = "none", $.dataTransfer.effectAllowed = "none");
    };
    return fe(() => {
      g.value = new zr({
        area: D.value,
      ...
      })), g.value.subscribe("predragstart", ({ event: $, isDragging: T }) => {
        if (T)
          y.value = g.value.getSelection().length, g.value.break();
        else {
          const C = $.target.offsetWidth - $.offsetX, U = $.target.offsetHeight - $.offsetY;
          C < 15 && U < 15 && (g.value.clearSelection(), g.value.break());
        }
      }), g.value.subscribe("predragmove", ({ isDragging: $ }) => {
        $ && g.value.break();
      }), g.value.subscribe("callback", ({ items: $, event: T, isDragging: C }) => {
        a.emit("vf-nodes-selected", K()), y.value = g.value.getSelection().length;
      });
    }), fe(() => {
      Je(() => h.view, () => a.emit("vf-explorer-update"));
    }), ($, T) => (x(), P("div", Jr, [
      p.view == "list" ? (x(), P("div", Zr, [
        i("div", {
          onClick: T[0] || (T[0] = (C) => B("basename")),
          ...
          G(X(me, {
            ...
            [_e, S.active && S.column == "basename"]
          ])
        ]),
        i("div", {
          onClick: T[1] || (T[1] = (C) => B("file_size")),
          ...
          G(X(me, {
            ...
            [_e, S.active && S.column == "file_size"]
          ])
        ]),
        i("div", {
          onClick: T[2] || (T[2] = (C) => B("last_modified")),
          ...
          G(X(me, {
            ...
            [_e, S.active && S.column == "last_modified"]
          ])
        ])
      ])) : W("", !0),
      i("div", {
        ...
        ref: (C) => D.value = C,
        onContextmenu: T[3] || (T[3] = de((C) => j(a).emit("vf-contextmenu-show", { event: C, area: D.value, items: K() }), ["self", "prevent"]))
      }, [
        p.view == "list" ? (x(!0), P(Q, { key: 0 }, ee(A(), (C, U) => (x(), P("div", {
          draggable: "true",
          onDblclick: (L) => w(C),
          onContextmenu: de((L) => j(a).emit("vf-contextmenu-show", { event: L, area: D.value, items: K(), target: C }), ["prevent"]),
          onDragstart: (L) => E(L),
          onDragover: (L) => re(L, C),
          onDrop: (L) => te(L, C),
          ...
          i("div", tn, [
            i("div", rn, [
              C.type == "dir" ? (x(), P("svg", nn, sn)) : (x(), P("svg", an, cn)),
              i("span", un, N(C.basename), 1)
            ]),
            i("div", dn, N(C.file_size ? j(Kr)(C.file_size) : ""), 1),
            i("div", mn, N(j(Br)(C.last_modified)), 1)
          ])
        ], 40, en))), 256)) : W("", !0),
        p.view == "grid" ? (x(!0), P(Q, { key: 1 }, ee(A(!1), (C, U) => (x(), P("div", {
          draggable: "true",
          onDblclick: (L) => w(C),
          onContextmenu: de((L) => j(a).emit("vf-contextmenu-show", { event: L, area: D.value, items: K(), target: C }), ["prevent"]),
          onDragstart: (L) => E(L),
          ...
          i("div", null, [
            i("div", fn, [
              C.type == "dir" ? (x(), P("svg", gn, pn)) : (x(), P("svg", bn, _n)),
              i("div", Sn, N(d(C.extension)), 1)
            ]),
            i("span", wn, N(o(C.basename)), 1)
          ])
        ], 40, hn))), 256)) : W("", !0),
        i("div", xn, [
          i("div", {
            ...
            kn,
            i("div", Dn, N(y.value), 1)
          ], 512)
        ])
      ], 544)
    ]));
  }
}), Pn = { class: "flex p-1.5 bg-neutral-100 dark:bg-gray-800 border-t border-b border-neutral-300 dark:border-gray-700/50 items-center select-none" }, Mn = /* @__PURE__ */ i("path", {
  "fill-rule": "evenodd",
  d: "M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z",
  "clip-rule": "evenodd"
}, null, -1), jn = [
  Mn
], An = { class: "flex bg-white dark:bg-gray-700 items-center rounded p-1 ml-2 w-full" }, En = /* @__PURE__ */ i("path", { d: "M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" }, null, -1), Tn = [
  En
], In = { class: "flex leading-5" }, Vn = /* @__PURE__ */ i("span", { class: "text-neutral-300 dark:text-gray-600 mx-0.5" }, "/", -1), Ln = ["title", "onClick"], On = {
  name: "VFBreadcrumb"
  ...
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = I(null), o = I([]);
    a.on("vf-explorer-update", (y) => {
      var S;
      let g = [], w = [];
      d.value = (S = h.data.dirname) != null ? S : "", d.value.length == 0 && (o.value = []), d.value.split("/").forEach(function(A) {
        g.push(A), g.join("/") != "" && w.push({
          basename: A,
          name: A,
          path: g.join("/"),
          type: "dir"
        });
      }), w.length > 4 && (w = w.slice(-5), w[0].name = ".."), o.value = w;
    });
    const D = (y) => {
      var w;
      y.preventDefault();
      let g = JSON.parse(y.dataTransfer.getData("items"));
      if (g.find((S) => S.storage != _("adapter"))) {
        alert("Moving items between different storages is not supported yet.");
        return;
      }
      a.emit("vf-modal-show", {
        type: "move",
        items: { from: g, to: (w = o.value[o.value.length - 2]) != null ? w : { path: "/" } }
      });
    }, b = (y) => {
      y.preventDefault(), o.value.length < 1 && (y.dataTransfer.dropEffect = "none", y.dataTransfer.effectAllowed = "none");
    };
    return (y, g) => (x(), P("div", Pn, [
      (x(), P("svg", {
        onDragover: g[0] || (g[0] = (w) => b(w)),
        onDrop: g[1] || (g[1] = (w) => D(w)),
        onClick: g[2] || (g[2] = (w) => {
          var S, A;
          return !o.value.length || j(a).emit("vf-fetch", { q: "index", adapter: p.data.adapter, path: (A = (S = o.value[o.value.length - 2]) == null ? void 0 : S.path) != null ? A : "" });
        }),
        class: ae(["h-6 w-6 p-0.5 rounded", o.value.length ? "text-slate-700 hover:bg-neutral-300 dark:text-neutral-200 dark:hover:bg-gray-700 cursor-pointer" : "text-gray-400 dark:text-neutral-500"]),
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 20 20",
        fill: "currentColor"
      }, jn, 34)),
      i("div", An, [
        (x(), P("svg", {
          onClick: g[3] || (g[3] = (w) => j(a).emit("vf-fetch", { q: "index", adapter: p.data.adapter })),
        ...
        i("div", In, [
          (x(!0), P(Q, null, ee(o.value, (w, S) => (x(), P("div", { key: S }, [
            Vn,
            i("span", {
              class: "px-1.5 py-1 text-slate-700 dark:text-slate-200 hover:bg-neutral-100 dark:hover:bg-gray-800 rounded cursor-pointer",
              title: w.basename,
              onClick: (A) => j(a).emit("vf-fetch", { q: "index", adapter: p.data.adapter, path: w.path })
            }, N(w.name), 9, Ln)
          ]))), 128))
        ])
      ])
  ...
  setup(p) {
    ...
    return fe(() => {
      ...
      role: "dialog",
      "aria-modal": "true",
      onKeyup: _[1] || (_[1] = le((d) => j(h).emit("vf-modal-close"), ["esc"])),
      tabindex: "0"
    }, [
      zn,
      i("div", Kn, [
        i("div", {
          ...
          onClick: _[0] || (_[0] = de((d) => j(h).emit("vf-modal-close"), ["self"]))
        }, [
          i("div", Bn, [
            i("div", Hn, [
              We(a.$slots, "default")
...
], -1), Yn = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, Jn = /* @__PURE__ */ i("h3", {
  ...
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = I(h.selection.items), o = () => {
      d.value.length && a.emit("vf-fetch", {
        q: "delete",
        adapter: _("adapter"),
        path: h.current.dirname,
        items: JSON.stringify(d.value.map(({ path: D, type: b }) => ({ path: D, type: b })))
      });
    };
    return (D, b) => {
      const y = R("v-f-modal");
      return x(), q(y, null, {
        buttons: z(() => [
          ...
          i("button", {
            type: "button",
            onClick: b[0] || (b[0] = (g) => j(a).emit("vf-modal-close")),
        ...
        default: z(() => [
          i("div", qn, [
            ...
            i("div", Yn, [
              ...
              i("div", Zn, [
                Xn,
                (x(!0), P(Q, null, ee(d.value, (g) => (x(), P("p", Gn, [
                  g.type == "dir" ? (x(), P("svg", Qn, to)) : (x(), P("svg", ro, oo)),
                  i("span", so, N(g.basename), 1)
                ]))), 256))
              ])
            ])
          ])
    ...
    return (a, _) => {
      ...
      return x(), q(d, null, {
        buttons: z(() => [
          i("button", {
            type: "button",
            onClick: _[0] || (_[0] = (o) => j(h).emit("vf-modal-close")),
            class: "mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          }, "Close")
        ]),
        default: z(() => {
          ...
          return [
            i("div", co, [
              uo,
              i("div", mo, [
                i("h3", ho, N((D = (o = p.selection) == null ? void 0 : o.title) != null ? D : "Title"), 1),
                i("div", fo, [
                  i("p", go, N((y = (b = p.selection) == null ? void 0 : b.message) != null ? y : "Message") + ".", 1)
                ])
              ])
            ])
          ];
  ...
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "New Folder", -1), wo = { class: "mt-2" }, xo = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, "Create a new folder", -1), ko = ["onKeyup"], Do = {
  ...
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = I(""), o = () => {
      d.value != "" && a.emit("vf-fetch", {
        q: "newfolder",
        adapter: _("adapter"),
        path: h.current.dirname,
        name: d.value
    ...
    return (D, b) => {
      ...
      return x(), q(y, null, {
        buttons: z(() => [
          ...
          i("button", {
            type: "button",
            onClick: b[1] || (b[1] = (g) => j(a).emit("vf-modal-close")),
            class: "mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          }, "Cancel")
        ]),
        default: z(() => [
...
}), Co = { class: "sm:flex sm:items-start" }, Po = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-50 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    class: "h-6 w-6 stroke-blue-600 dark:stroke-blue-100",
    fill: "none",
...
], -1), Mo = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, jo = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "New File", -1), Ao = { class: "mt-2" }, Eo = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, "Create a new file", -1), To = ["onKeyup"], Io = {
  name: "VFModalNewFile"
}, Vo = /* @__PURE__ */ Object.assign(Io, {
  props: {
    selection: Object,
    current: Object
  },
...
}), Lo = { class: "sm:flex sm:items-start" }, Oo = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), No = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, zo = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "Preview Files", -1), Ko = { class: "mt-2" }, Bo = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, "Image, text preview etc.", -1), Ho = /* @__PURE__ */ i("button", {
  type: "button",
  class: "w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm"
}, "Yes, delete!", -1), Ro = {
  name: "VFModalPreview"
  ...
  setup(p) {
    const h = p, a = inject("emitter");
    return console.log(h.selection), (_, d) => {
      const o = R("v-f-modal");
      return x(), q(o, null, {
        buttons: z(() => [
          Ho,
          i("button", {
            type: "button",
            onClick: d[0] || (d[0] = (D) => j(a).emit("vf-modal-close")),
            class: "mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          }, "Cancel")
        ]),
        default: z(() => [
          i("div", Lo, [
            ...
            i("div", No, [
              ...
              i("div", Ko, [
                Bo,
                i("p", null, "adapter: " + N(p.selection.adapter), 1),
                i("p", null, "path: " + N(p.selection.item.path), 1)
              ])
            ])
          ])
        ]),
...
}), Uo = { class: "sm:flex sm:items-start" }, qo = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-50 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    class: "h-6 w-6 stroke-blue-600 dark:stroke-blue-100",
    fill: "none",
...
], -1), Wo = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, Yo = {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, Jo = { class: "mt-2" }, Zo = { class: "flex text-sm text-gray-800 dark:text-gray-400 py-2" }, Xo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  ts
], ns = { class: "ml-1.5" }, os = ["onKeyup"], ss = {
  name: "VFModalRename"
}, is = /* @__PURE__ */ Object.assign(ss, {
  props: {
    selection: Object,
    current: Object
  },
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = I(h.selection.items[0]), o = I(h.selection.items[0].basename), D = () => {
      ...
      return x(), q(g, null, {
        ...
        default: z(() => [
          i("div", Uo, [
            qo,
            i("div", Wo, [
              i("h3", Yo, "Rename your " + N(d.value.type == "dir" ? "folder" : "file"), 1),
              i("div", Jo, [
                i("p", Zo, [
                  d.value.type == "dir" ? (x(), P("svg", Xo, Qo)) : (x(), P("svg", es, rs)),
                  i("span", ns, N(d.value.basename), 1)
                ]),
                G(i("input", {
...
}), as = /* @__PURE__ */ i("div", { class: "sm:flex sm:items-start" }, [
...
}), ds = { class: "sm:flex sm:items-start" }, ms = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-50 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    class: "h-6 w-6 stroke-blue-600 dark:stroke-blue-100",
    fill: "none",
...
], -1), hs = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, fs = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "Archive files", -1), gs = { class: "mt-2" }, vs = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, ps = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  Ss
], xs = { class: "ml-1.5" }, ks = /* @__PURE__ */ i("p", { class: "my-1 text-sm text-gray-500" }, "Archive name. (.zip file will be created)", -1), Ds = ["onKeyup"], $s = {
  name: "VFModalArchive"
  ...
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = I(""), o = I(h.selection.items), D = () => {
      o.value.length && a.emit("vf-fetch", {
        q: "archive",
        adapter: _("adapter"),
        path: h.current.dirname,
        items: JSON.stringify(o.value.map(({ path: b, type: y }) => ({ path: b, type: y }))),
        name: d.value
      });
    };
    return (b, y) => {
        ...
        default: z(() => [
          i("div", ds, [
            ...
            i("div", hs, [
              fs,
              i("div", gs, [
                (x(!0), P(Q, null, ee(o.value, (w) => (x(), P("p", vs, [
                  w.type == "dir" ? (x(), P("svg", ps, ys)) : (x(), P("svg", _s, ws)),
                  i("span", xs, N(w.basename), 1)
                ]))), 256)),
                ks,
                G(i("input", {
...
}), Ps = { class: "sm:flex sm:items-start" }, Ms = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), js = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, As = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "Move files", -1), Es = { class: "mt-2" }, Ts = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, Is = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  Ns
], Ks = { class: "ml-1.5" }, Bs = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500 pb-1 pt-3" }, "Are you sure you want to move these files to ?", -1), Hs = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, Rs = /* @__PURE__ */ i("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  viewBox: "0 0 24 24",
...
], -1), Fs = { class: "ml-1.5 overflow-auto" }, Us = {
  name: "VFModalMove"
}, qs = /* @__PURE__ */ Object.assign(Us, {
  props: {
    selection: Object,
    current: Object
  },
  setup(p) {
    const h = p, a = inject("emitter"), { getStore: _ } = inject("storage"), d = I(h.selection.items.from), o = () => {
      d.value.length && a.emit("vf-fetch", {
        q: "move",
        adapter: _("adapter"),
        path: h.current.dirname,
        ...
        default: z(() => [
          i("div", Ps, [
            ...
            i("div", js, [
              As,
              i("div", Es, [
                (x(!0), P(Q, null, ee(d.value, (g) => (x(), P("p", Ts, [
                  g.type == "dir" ? (x(), P("svg", Is, Ls)) : (x(), P("svg", Os, zs)),
                  i("span", Ks, N(g.path), 1)
                ]))), 256)),
                Bs,
                i("p", Hs, [
                  Rs,
                  i("span", Fs, N(p.selection.items.to.path), 1)
                ])
              ])
            ])
          ])
...
}), Ws = ["onClick"], Ys = /* @__PURE__ */ i("span", { class: "px-1" }, null, -1), Js = {
  name: "VFContextMenu"
  ...
  setup(p) {
    const h = p, a = inject("emitter"), _ = I(null), d = he({
      active: !1,
      items: [],
      positions: {
        left: 0,
    ...
    const D = {
      ...
      a.emit("vf-contextmenu-hide"), g.action();
    };
    a.on("vf-contextmenu-show", ({ event: g, area: w, items: S, target: A = null }) => {
      d.items = [], A ? S.length > 1 && S.some((B) => B.path === A.path) ? (d.items.push(D.refresh), d.items.push(D.archive), d.items.push(D.delete), a.emit("vf-context-selected", S), console.log(S.length + " selected (more than 1 item.)")) : (d.items.push(D.refresh), d.items.push(D.preview), d.items.push(D.rename), d.items.push(D.archive), d.items.push(D.delete), a.emit("vf-context-selected", [A]), console.log(A.type + " is selected")) : (d.items.push(D.refresh), d.items.push(D.newfolder), a.emit("vf-context-selected", []), console.log("no files selected")), y(g, w);
    }), a.on("vf-contextmenu-hide", () => {
      d.active = !1;
    });
    const y = (g, w) => {
      d.active = !0, Ze(() => {
        let S = w.getBoundingClientRect(), A = g.pageX, B = g.pageY, K = _.value.offsetHeight, E = _.value.offsetWidth;
        A = S.right - g.pageX + window.scrollX < E ? A - E : A, B = S.bottom - g.pageY + window.scrollY < K ? B - K : B, d.positions = {
          left: A + "px",
          top: B + "px"
        };
      });
    };
    return (g, w) => d.active ? (x(), P("ul", {
      key: 0,
      ...
      ref: (S) => _.value = S,
      style: Xt(d.positions)
    }, [
      (x(!0), P(Q, null, ee(d.items, (S) => (x(), P("li", {
        class: "px-2 py-1.5 cursor-pointer hover:bg-neutral-200 dark:hover:bg-gray-700",
        key: S.title,
        onClick: (A) => b(S)
      }, [
        Ys,
        i("span", null, N(S.title), 1)
      ], 8, Ws))), 128))
    ], 4)) : W("", !0);
  }
}), Se = {
