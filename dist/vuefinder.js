...
}), Pr = { class: "p-1 text-xs border-t border-neutral-300 dark:border-gray-700 flex justify-between select-none" }, Mr = { class: "flex leading-5 items-center" }, jr = /* @__PURE__ */ i("div", {
  class: "mx-2",
  "aria-label": "Storage",
...
}), Po = { class: "flex p-1.5 bg-neutral-100 dark:bg-gray-800 border-t border-b border-neutral-300 dark:border-gray-900 items-center select-none" }, Mo = /* @__PURE__ */ i("path", {
  "fill-rule": "evenodd",
