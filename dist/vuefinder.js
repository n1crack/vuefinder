import { reactive as Et, watch as ae, ref as D, shallowRef as Rn, computed as G, markRaw as go, useTemplateRef as He, defineComponent as Q, inject as J, onMounted as re, nextTick as Ie, createElementBlock as h, openBlock as v, withKeys as ct, unref as l, createElementVNode as o, createCommentVNode as O, withModifiers as le, renderSlot as Fe, toDisplayString as b, createBlock as P, resolveDynamicComponent as Ln, onUnmounted as xe, normalizeClass as q, withCtx as Y, createVNode as L, Fragment as ie, renderList as ce, createTextVNode as X, withDirectives as _e, vModelSelect as Xt, vModelText as ut, resolveComponent as Vn, vModelCheckbox as nn, customRef as wo, Teleport as Dt, normalizeStyle as Be, isRef as yo, onBeforeUnmount as bo, vModelRadio as Wt, mergeProps as Ee, toHandlers as Ne, vShow as Pe, normalizeProps as it, guardReactiveProps as at, TransitionGroup as ko, onUpdated as xo, mergeModels as $o, useModel as Pn, provide as jt, Transition as Co } from "vue";
...
function Oo(t, e, n, s) {
  const { getStore: i, setStore: r } = t, a = D({}), u = D(i("locale", e)), c = (f, g = e) => {
    Io(f, s).then((y) => {
...
function Po() {
  const t = Rn(null), e = D(!1), n = D(), s = D(!1);
...
const Ko = ["data-theme"], Wo = { class: "vuefinder__modal-layout__container" }, jo = { class: "vuefinder__modal-layout__content" }, Go = {
  ...
  setup(t) {
    const e = D(null), n = J("ServiceContainer"), s = t, i = vt();
    re(() => {
  ...
  setup(t, { emit: e, slots: n }) {
    const s = J("ServiceContainer"), i = D(!1), { t: r } = s.i18n;
    let a = null;
    const u = () => {
...
const Hn = { render: ss }, ls = { class: "vuefinder__about-modal__content" }, is = { class: "vuefinder__about-modal__main" }, as = {
  ...
  for: "large_icons",
  class: "vuefinder__about-modal__label"
}, Ss = { class: "vuefinder__about-modal__setting vuefinder__about-modal__setting--flex" }, Fs = { class: "vuefinder__about-modal__setting-input" }, Es = ["checked"], Ds = { class: "vuefinder__about-modal__setting-label" }, As = {
  for: "persist_path",
  class: "vuefinder__about-modal__label"
  ...
  __name: "ModalAbout",
  setup(t) {
    const e = J("ServiceContainer"), n = J("setTheme"), s = e.config, { clearStore: i } = e.storage, { t: r } = e.i18n, a = {
      ABOUT: "about",
      SETTINGS: "settings",
      SHORTCUTS: "shortcuts",
      RESET: "reset"
    ...
    }, { i18n: C } = J("VueFinderOptions"), m = Object.fromEntries(
      Object.entries({
        ar: "Arabic (العربيّة)",
        en: "English",
        fr: "French (Français)",
              ...
              o("div", ms, [
                o("fieldset", null, [
                  ...
                  o("div", Ss, [
                    ...
                    o("div", Ds, [
                      o("label", As, [
                        X(b(l(r)("Persist path on reload")) + " ", 1),
                        L(Ze, {
                          class: "ms-3",
...
const Nn = { render: cl }, ul = { class: "vuefinder__delete-modal__content" }, vl = { class: "vuefinder__delete-modal__form" }, fl = { class: "vuefinder__delete-modal__description" }, _l = { class: "vuefinder__delete-modal__files vf-scrollbar" }, ml = { class: "vuefinder__delete-modal__file" }, pl = {
  ...
  __name: "ModalDelete",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.path), r = D(e.modal.data.items), a = D(""), u = () => {
...
const Un = { render: bl }, kl = { class: "vuefinder__rename-modal__content" }, xl = { class: "vuefinder__rename-modal__item" }, $l = { class: "vuefinder__rename-modal__item-info" }, Cl = {
  ...
  __name: "ModalRename",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.path), r = D(e.modal.data.items[0]), a = D(r.value.basename), u = D(""), c = () => {
...
}), El = { class: "vuefinder__text-preview" }, Dl = { class: "vuefinder__text-preview__header" }, Al = ["title"], Tl = { class: "vuefinder__text-preview__actions" }, Ml = {
  key: 0,
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = e, s = D(""), i = D(""), r = D(null), a = D(!1), u = D(""), c = D(!1), _ = J("ServiceContainer"), { t: d } = _.i18n;
    re(async () => {
      try {
    ...
    const f = () => {
      ...
      try {
        ...
        const E = y;
        u.value = d(E.message || "Error"), c.value = !0;
      }
    };
    return (y, E) => (v(), h("div", El, [
      o("div", Dl, [
        o("div", {
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = e, s = J("ServiceContainer"), { t: i } = s.i18n, r = D(!1), a = D(""), u = D(!1), c = D(s.adapter.getPreviewUrl({ path: s.modal.data.item.path })), _ = D(c.value), d = He("cropperRef"), f = async () => {
...
const wt = { render: Ul }, Kl = { class: "vuefinder__default-preview" }, Wl = { class: "vuefinder__default-preview__content" }, jl = { class: "vuefinder__default-preview__header" }, Gl = ["title"], ql = { class: "vuefinder__default-preview__icon-container" }, Yl = ["title"], Ql = /* @__PURE__ */ Q({
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = J("ServiceContainer"), s = e;
    return re(() => {
      s("success");
    }), (i, r) => (v(), h("div", Kl, [
      o("div", Wl, [
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = J("ServiceContainer"), s = e, i = () => n.adapter.getPreviewUrl({ path: n.modal.data.item.path });
    return re(() => {
      s("success");
    }), (r, a) => (v(), h("div", Xl, [
      o("h3", {
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = e, s = J("ServiceContainer"), i = () => s.adapter.getPreviewUrl({ path: s.modal.data.item.path });
    return re(() => {
      n("success");
    }), (r, a) => (v(), h("div", ni, [
      o("h3", {
...
const fi = {
  ...
  __name: "ModalPreview",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = D(!1), i = (C) => (e.modal.data.item.mime_type ?? "").startsWith(C), r = e.features.includes(ee.PREVIEW);
    r || (s.value = !0);
      ...
      default: Y(() => [
        ...
        o("div", yi, [
          o("div", null, [
            ...
            X(b(l(e).filesize(l(e).modal.data.item.file_size)), 1)
          ]),
          o("div", null, [
            o("span", ki, b(l(n)("Last Modified")) + ": ", 1),
            X(" " + b(l(vi)(l(e).modal.data.item.last_modified)), 1)
          ])
        ]),
...
const rn = { render: Bi }, zi = { class: "vuefinder__modal-tree__folder-item" }, Hi = { class: "vuefinder__modal-tree__folder-content" }, Ni = {
  ...
  setup(t, { emit: e }) {
    const n = J("ServiceContainer"), { t: s } = n.i18n, i = n.fs, r = t, a = e;
    j(i.path);
    const u = G(() => {
  ...
  setup(t, { emit: e }) {
    const n = J("ServiceContainer"), { t: s } = n.i18n, i = n.fs, r = n.config, a = e, u = j(i.sortedFiles), c = j(i.storages), _ = j(i.path), d = D(null), f = D({}), g = D({});
    ae(u, (A) => {
  ...
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = t, i = D(e.modal.data.items.from), r = D(e.modal.data.items.to), a = D(""), u = D(s.copy || !1), c = G(() => u.value ? "copy" : "move"), _ = D(!1), d = G(() => u.value ? n("Copy files") : n("Move files")), f = G(() => u.value ? n("Are you sure you want to copy these files?") : n("Are you sure you want to move these files?")), g = G(() => u.value ? n("Yes, Copy!") : n("Yes, Move!"));
...
const Lt = { render: Aa }, Ta = { class: "vuefinder__search-modal__search-input" }, Ma = ["value", "placeholder", "disabled"], Ia = {
  ...
  setup(t, { expose: e, emit: n }) {
    const s = n, i = J("ServiceContainer"), { t: r } = i.i18n, a = D(null), u = (_) => {
      const d = _.target;
...
const ja = async (t, e, n) => {
  ...
  for (let C = 0; C < u.length; C++) {
    ...
    }, M && E <= 50 && (E++, typeof M == "object" && (M.placement && (g = M.placement), M.rects && (_ = M.rects === !0 ? await a.getElementRects({
      reference: t,
      floating: e,
      strategy: i
    }) : M.rects), {
...
async function Yn(t, e) {
  ...
  const {
    ...
    altBoundary: g = !1,
    padding: y = 0
  } = Vt(e, t), E = Wa(y), p = u[g ? f === "floating" ? "reference" : "floating" : f], m = xt(await r.getClippingRect({
  ...
  return {
    top: (m.top - M.top + E.top) / x.y,
    bottom: (M.bottom - m.bottom + E.bottom) / x.y,
    left: (m.left - M.left + E.left) / x.x,
    right: (M.right - m.right + E.right) / x.x
  };
}
const Ga = function(t) {
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = r.arrow) != null && n.alignmentOffset)
        return {};
      const m = Ye(i), k = Ue(u), w = Ye(u) === u, x = await (c.isRTL == null ? void 0 : c.isRTL(_.floating)), M = g || (w || !C ? [kt(u)] : Ba(u)), A = E !== "none";
      !g && A && M.push(...Ua(u, C, E, x));
...
async function Ya(t, e) {
  ...
  return u && typeof E == "number" && (y = u === "end" ? E * -1 : E), c ? {
    x: y * d,
    y: g * _
  } : {
    x: g * _,
...
const Qa = function(t) {
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (a) {
        const p = f === "y" ? "top" : "left", m = f === "y" ? "bottom" : "right", k = E + d[p], w = E - d[m];
        E = xn(k, E, w);
      }
      const C = u.fn({
        ...e,
...
function Qe(t, e, n, s) {
  ...
  if (r) {
    ...
    for (; C && s && y !== E; ) {
      ...
      c *= p.x, _ *= p.y, d *= p.x, f *= p.y, c += w, _ += x, E = Se(C), C = en(E);
    }
  }
  return xt({
    width: d,
...
function vr(t, e) {
  ...
  const _ = Nt(s);
  if (_ <= 0) {
    const d = s.ownerDocument, f = d.body, g = getComputedStyle(f), y = d.compatMode === "CSS1Compat" && parseFloat(g.marginLeft) + parseFloat(g.marginRight) || 0, E = Math.abs(s.clientWidth - f.clientWidth - y);
    E <= En && (r -= E);
  } else _ <= En && (r += _);
  return {
    width: r,
...
function to(t, e) {
  const n = Ke(t);
  return n === e || !De(n) || nt(n) ? !1 : Ae(n).position === "fixed" || to(n, e);
}
function mr(t, e) {
  const n = e.get(t);
  if (n)
    return n;
  let s = rt(t, [], !1).filter((u) => De(u) && ot(u) !== "body"), i = null;
...
function kr(t, e) {
  ...
  function a(u, c) {
    ...
    if (u || e(), !g || !y)
      return;
    const E = gt(f), C = gt(i.clientWidth - (d + g)), p = gt(i.clientHeight - (f + y)), m = gt(d), w = {
      rootMargin: -E + "px " + -C + "px " + -p + "px " + -m + "px",
...
function so(t, e, n, s) {
  ...
  function p() {
    const m = Qe(t);
    C && !oo(C, m) && n(), C = m, E = requestAnimationFrame(p);
  }
  return n(), () => {
    var m;
    d.forEach((k) => {
      i && k.removeEventListener("scroll", n), r && k.removeEventListener("resize", n);
    }), f?.(), (m = y) == null || m.disconnect(), y = null, c && cancelAnimationFrame(E);
  };
}
const $t = Qa, Ct = Xa, St = Ga, Ft = (t, e, n) => {
...
}, xr = ["disabled", "title"], $r = ["data-theme"], Cr = { class: "vuefinder__search-modal__dropdown-content" }, Sr = { class: "vuefinder__search-modal__dropdown-section" }, Fr = { class: "vuefinder__search-modal__dropdown-title" }, Er = { class: "vuefinder__search-modal__dropdown-options" }, Dr = {
  key: 0,
  ...
  setup(t, { expose: e, emit: n }) {
    const s = t, i = n, r = J("ServiceContainer"), { t: a } = r.i18n, u = D(null), c = D(null), _ = vt();
    let d = null;
    const f = (p) => {
            ...
            o("div", Sr, [
              ...
              o("div", Er, [
                o("div", {
                  ...
                  t.sizeFilter === "all" ? (v(), h("div", Dr, [...m[5] || (m[5] = [
                    o("svg", {
                      viewBox: "0 0 16 16",
                      fill: "currentColor"
                    }, [
...
const ao = { render: Pr }, Br = ["title"], zr = { class: "vuefinder__search-modal__result-icon" }, Hr = { class: "vuefinder__search-modal__result-content" }, Nr = { class: "vuefinder__search-modal__result-name" }, Ur = {
  ...
  setup(t, { emit: e }) {
    const n = t, s = e, i = J("ServiceContainer"), { t: r } = i.i18n, a = vt(), u = D(null);
    let c = null;
    ...
    const _ = (k) => n.expandedPaths.has(k), d = (k) => k.type === "dir" || !k.file_size ? "" : on(k.file_size), f = (k, w) => {
      ...
      if (k.key === "ArrowDown") {
        ...
        s("update:selectedItemDropdownOption", `${w[A] || ""}-${n.activeDropdown}`);
      } else k.key === "Enter" ? (k.preventDefault(), x && (x.includes("copy-path") ? E(n.item) : x.includes("open-folder") ? C(n.item) : x.includes("preview") && p(n.item))) : k.key === "Escape" && (k.preventDefault(), s("update:selectedItemDropdownOption", null));
    };
    return (k, w) => (v(), h("div", {
        ...
        t.activeDropdown === t.item.path ? (v(), h("div", {
          ...
          o("div", Gr, [
            o("div", {
              ...
              onClick: w[2] || (w[2] = (x) => {
                y(`copy-path-${t.item.path}`), E(t.item);
              }),
  ...
  setup(t, { expose: e, emit: n }) {
    const s = t, i = n, r = J("ServiceContainer"), { t: a } = r.i18n, u = He("scrollableContainer"), c = G(() => s.searchResults.length > 0), _ = G(() => s.searchResults.length), d = D(0), f = D(600), g = G(() => s.searchResults.length * Ge), y = G(() => {
      ...
      t.isSearching ? (v(), h("div", Yr, [
        ...
        o("div", {
          ...
          o("div", {
            ...
            (v(!0), h(ie, null, ce(E.value, (M) => (v(), h("div", {
              key: M.item.path,
              style: Be({
                position: "absolute",
                top: `${M.top}px`,
  ...
  __name: "ModalSearch",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = D(null), r = D(null), a = D(null), u = Wn("", 300), c = D([]), _ = D(!1), d = D(-1), f = D(!1), g = D(!1), y = D(null), E = D("all"), C = D(!1), p = D(`size-${E.value}`), m = D(null), k = D(/* @__PURE__ */ new Set()), w = D(null), x = j(s.path), M = ($) => {
    ...
    re(() => {
      document.addEventListener("click", F), p.value = `size-${E.value}`, Ie(() => {
          ...
          o("div", nd, [
            o("div", od, [
              ...
              L(Ir, {
                ...
                "size-filter": E.value,
                "onUpdate:sizeFilter": S[2] || (S[2] = (I) => E.value = I),
...
const ro = { render: pd }, hd = { class: "vuefinder__new-folder-modal__content" }, gd = { class: "vuefinder__new-folder-modal__form" }, wd = { class: "vuefinder__new-folder-modal__description" }, yd = ["placeholder"], hn = /* @__PURE__ */ Q({
  ...
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.path), r = D(""), a = D(""), u = () => {
...
const co = { render: kd }, xd = { class: "vuefinder__new-file-modal__content" }, $d = { class: "vuefinder__new-file-modal__form" }, Cd = { class: "vuefinder__new-file-modal__description" }, Sd = ["placeholder"], uo = /* @__PURE__ */ Q({
  ...
  emits: ["hidden"],
  setup(t, { emit: e }) {
    const n = e, s = J("ServiceContainer"), { t: i } = s.i18n, r = D(!1), a = D(null), u = D(a.value?.innerHTML);
    ae(u, () => r.value = !1);
    const c = () => {
      n("hidden"), r.value = !0;
    };
...
function Dd(t) {
  const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.path), r = e.config, a = D({ QUEUE_ENTRY_STATUS: be }), u = D(null), c = D(null), _ = D(null), d = D(null), f = D(null), g = D([]), y = D(""), E = D(!1), C = D(!1), p = D(null);
  let m;
  const k = (F) => {
    ...
    if (E.value || !g.value.filter(($) => $.status !== be.DONE).length) {
    ...
    E.value || (m.removeFile(F.id), g.value.splice(A(F.id), 1));
  }, ve = (F) => {
    if (!E.value)
      if (m.cancelAll(), F) {
  ...
  return re(() => {
    ...
    m.on("restriction-failed", (I, V) => {
      ...
      y.value = I.message, E.value = !1, e.adapter.open(i.value.path);
    }), m.on("complete", () => {
      E.value = !1;
...
const vo = { render: Td }, Md = { class: "vuefinder__upload-modal__content relative" }, Id = { class: "vuefinder__upload-modal__target-section" }, Od = { class: "vuefinder__upload-modal__target-label" }, Rd = { class: "vuefinder__upload-modal__target-container" }, Ld = { class: "vuefinder__upload-modal__target-path" }, Vd = { class: "vuefinder__upload-modal__target-storage" }, Pd = {
  ...
  __name: "ModalUpload",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.path), r = D(i.value), a = D(!1), u = () => {
    ...
    const Z = D(!1), oe = D(null), ve = D(null), fe = (F) => {
      if (!Z.value) return;
      ...
      default: Y(() => [
        o("div", null, [
          ...
          o("div", Md, [
            ...
            o("div", Hd, [
              (v(!0), h(ie, null, ce(l(E), (S) => (v(), h("div", {
              ...
              l(E).length ? O("", !0) : (v(), h("div", qd, b(l(n)("No files selected!")), 1))
            ]),
            l(C).length ? (v(), P(Ed, {
              key: 0,
...
const fo = { render: lc }, ic = { class: "vuefinder__unarchive-modal__content" }, ac = { class: "vuefinder__unarchive-modal__items" }, rc = {
  ...
  setup(t) {
    const e = J("ServiceContainer"), n = e.fs, s = j(n.path), { t: i } = e.i18n, r = D(e.modal.data.items[0]), a = D(""), u = D([]), c = () => {
      e.adapter.unarchive({
        item: r.value.path,
        path: s.value.path
      }).then((_) => {
...
const _o = { render: fc }, _c = { class: "vuefinder__archive-modal__content" }, mc = { class: "vuefinder__archive-modal__form" }, pc = { class: "vuefinder__archive-modal__files vf-scrollbar" }, hc = {
  ...
  __name: "ModalArchive",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.path), r = D(""), a = D(""), u = D(e.modal.data.items), c = () => {
  ...
  setup(t) {
    ...
    const { t: n } = e?.i18n || { t: (m) => m }, s = e?.fs, i = e?.config, r = j(i?.state || {}), a = j(s?.selectedItems || []), u = j(s?.storages || []), c = D(null), _ = D(!1), d = G(() => window.opener !== null || window.name !== "" || window.history.length <= 1), f = G(() => [
      {
        id: "file",
        label: n("File"),
        items: [
...
}, Fu = { class: "vuefinder__toolbar__dropdown-reset" }, Eu = ["title"], Du = ["title"], Au = /* @__PURE__ */ Q({
  name: "VfToolbar",
  __name: "Toolbar",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = e.config, r = j(i.state), a = j(s.selectedItems), u = j(s.sort), c = j(s.filter);
    ...
    const g = () => i.set("view", r.value.view === "grid" ? "list" : "grid"), y = G(() => c.value.kind !== "all" || !r.value.showHiddenFiles || u.value.active), E = () => {
      f.value = {
        sortBy: "name",
        sortOrder: "",
...
const tv = { class: "vuefinder__breadcrumb__container" }, nv = ["title"], ov = ["title"], sv = ["title"], lv = ["title"], iv = { class: "vuefinder__breadcrumb__path-container" }, av = { class: "vuefinder__breadcrumb__list" }, rv = {
  ...
  __name: "Breadcrumb",
  setup(t) {
    const e = J("ServiceContainer"), n = J("currentTheme"), { t: s } = e.i18n, i = e.fs, r = e.config, a = j(r.state), u = j(i.path), c = j(i.loading), _ = D(null), d = Wn(0, 100), f = D(5), g = D(!1), y = D(!1), E = G(() => u.value?.breadcrumb ?? []);
    function C(F, $) {
      return F.length > $ ? [F.slice(-$), F.slice(0, -$)] : [F, []];
    }
    const p = G(() => C(E.value, f.value)[0]), m = G(() => C(E.value, f.value)[1]);
    ae(d, () => {
      if (!_.value) return;
    ...
    return (F, $) => (v(), h("div", tv, [
      ...
      o("span", {
        ...
        L(l(Lu), Ee(Ne(E.value.length ? l(x).events(M()) : {}), {
          onClick: H,
      ...
      _e(o("div", iv, [
        o("div", null, [
          L(l(Nu), Ee({ class: "vuefinder__breadcrumb__home-icon" }, Ne(l(x).events(M(-1))), {
      ...
      (v(), P(Dt, { to: "body" }, [
        o("div", null, [
          _e(o("div", {
            ...
            (v(!0), h(ie, null, ce(m.value, (S, I) => (v(), h("div", Ee({ key: I }, Ne(l(x).events(S), !0), {
              onClick: (V) => U(S),
...
function kv(t, e) {
  const {
    ...
    lockItemsPerRow: u
  } = e, c = t, _ = () => typeof i == "number" ? i : i.value, d = D(0), f = D(6), g = D(600);
  let y = null;
  const E = G(() => Math.ceil(c.value.length / f.value)), C = G(() => E.value * _()), p = G(() => {
    const N = _(), ne = Math.max(0, Math.floor(d.value / N) - r), se = Math.min(E.value, Math.ceil((d.value + g.value) / N) + r);
...
function xv(t) {
  const { getItemPosition: e, getItemsInRange: n, getKey: s, selectionObject: i, rowHeight: r, itemWidth: a } = t, u = Math.floor(Math.random() * 2 ** 32).toString(), c = J("ServiceContainer"), _ = c.fs, d = j(_.selectedKeys), f = j(_.sortedFiles), g = D(/* @__PURE__ */ new Set()), y = D(!1), E = D(!1), C = D(null), p = (F) => F.map(($) => $.getAttribute("data-key")).filter(($) => !!$), m = (F) => {
    ...
    if (c.selectionMode === "single")
      return !1;
    y.value = !1, !F.event?.metaKey && !F.event?.ctrlKey && (E.value = !0), F.selection.resolveSelectables(), m(F), k(F);
  }, A = D(0), H = ({ event: F, selection: $ }) => {
    ...
    if (i.value && (y.value || E.value) && i.value.getSelectables()[0]?.closest(".scroller-" + u)) {
    ...
    E.value = !1, y.value = !0, S.forEach((V) => {
    ...
    const $ = F;
    !g.value.size && !E.value && !$?.ctrlKey && !$?.metaKey && (_.clearSelection(), i.value?.clearSelection());
  };
  return re(() => {
    const F = ($) => {
...
const Dv = { render: Ev }, Qt = /* @__PURE__ */ Q({
  __name: "SortIcon",
  props: {
    direction: {}
  },
  setup(t) {
    return (e, n) => (v(), h("div", null, [
      ...
      t.direction === "desc" ? (v(), P(l(Dv), { key: 1 })) : O("", !0)
    ]));
  }
}), Av = {
  xmlns: "http://www.w3.org/2000/svg",
...
const Mv = { render: Tv }, Iv = { class: "vuefinder__drag-item__container" }, Ov = { class: "vuefinder__drag-item__count" }, Rv = /* @__PURE__ */ Q({
  ...
  setup(t) {
    const e = t, n = J("ServiceContainer"), s = j(n.config.state), i = {
      app: n,
      config: s.value,
      item: e.item
    };
...
const In = { render: Pv }, Bv = ["data-key", "data-row", "data-col", "draggable"], zv = { key: 0 }, Hv = { class: "vuefinder__explorer__item-grid-content" }, Nv = ["data-src", "alt"], Uv = { class: "vuefinder__explorer__item-title" }, Kv = {
  ...
  setup(t, { emit: e }) {
    const n = t, s = e, i = J("ServiceContainer"), r = i.fs, a = i.config, u = G(() => {
    ...
    const C = () => {
      ...
      if (p.value = !1, g && (k.preventDefault(), clearTimeout(g)), !E)
        E = !0, s("click", k), y.value = setTimeout(() => {
          E = !1;
        }, 300);
      else
        return E = !1, s("dblclick", k), g && clearTimeout(g), !1;
  ...
  setup(t, { emit: e }) {
    ...
    return (u, c) => (v(), h("div", {
      ...
      o("div", {
        ...
        (v(!0), h(ie, null, ce(t.items, (_, d) => (v(), P(Jv, Ee({
          key: _.path,
          item: _,
          view: t.view,
          compact: t.compact,
          ...
          icon: Y((f) => [
            Fe(u.$slots, "icon", Ee({ ref_for: !0 }, f))
          ]),
          _: 3
  ...
  __name: "Toast",
  setup(t) {
    const e = J("ServiceContainer"), { getStore: n } = e.storage, s = D(n("full-screen", !1)), i = D([]), r = (c) => c === "error" ? "text-red-400 border-red-400 dark:text-red-300 dark:border-red-300" : "text-lime-600 border-lime-600 dark:text-lime-300 dark:border-lime-1300", a = (c) => {
      i.value.splice(c, 1);
    }, u = (c) => {
  ...
  setup(t) {
    const e = t, n = J("ServiceContainer"), s = _t(n, ["vuefinder__drag-over"]), i = He("dragImage"), r = Rn(null), a = He("scrollContainer"), u = He("scrollContent"), c = n.fs, _ = n.config, d = j(_.state), f = j(c.sort), g = j(c.sortedFiles), y = j(c.selectedKeys), E = j(c.loading), C = (B) => y.value?.has(B) ?? !1;
    let p = null;
    const m = D(null), k = He("customScrollBar"), w = He("customScrollBarContainer"), x = G(() => {
    ...
    return (B, te) => (v(), h("div", nf, [
      ...
      o("div", {
        ...
        l(_).get("loadingIndicator") === "linear" && l(E) ? (v(), h("div", lf)) : O("", !0),
        o("div", {
          ...
          l(d).view === "grid" ? (v(!0), h(ie, { key: 0 }, ce(l(U), (T) => (v(), P(On, {
            ...
            icon: Y((R) => [
              Fe(B.$slots, "icon", Ee({ ref_for: !0 }, R))
            ]),
            _: 3
  ...
  __name: "ContextMenu",
  setup(t) {
    const e = J("ServiceContainer"), n = D(null), s = D([]), i = Et({
      active: !1,
      items: [],
      positions: {
        left: "0px",
...
const ff = { render: vf }, _f = { class: "vuefinder__status-bar__wrapper" }, mf = { class: "vuefinder__status-bar__storage" }, pf = ["title"], hf = { class: "vuefinder__status-bar__storage-icon" }, gf = ["value"], wf = ["value"], yf = { class: "vuefinder__status-bar__info space-x-2" }, bf = { key: 0 }, kf = { key: 1 }, xf = {
  ...
  __name: "Statusbar",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, s = e.fs, i = j(s.sortedFiles), r = j(s.path), a = j(s.selectedCount), u = j(s.storages), c = j(s.selectedItems), _ = j(s.path), d = (g) => {
    ...
    return (g, y) => (v(), h("div", _f, [
      o("div", mf, [
        o("div", {
          ...
          o("select", {
            ...
            (v(!0), h(ie, null, ce(l(u), (E) => (v(), h("option", {
              value: E,
              key: E
            }, b(E), 9, wf))), 128))
          ], 40, gf)
      ...
      o("div", $f, [
        ...
        o("span", {
          ...
          title: l(n)("About"),
          onClick: y[0] || (y[0] = (E) => l(e).modal.open(sn))
        }, [
...
const Af = { class: "vuefinder__folder-loader-indicator" }, Tf = {
  ...
  setup(t) {
    const e = t, n = J("ServiceContainer"), s = Pn(t, "modelValue"), i = D(!1);
    ae(() => s.value, () => r());
    const r = async () => {
      i.value = !0;
      try {
  ...
  setup(t) {
    const e = J("ServiceContainer"), n = e.fs, s = _t(e, ["vuefinder__drag-over"]), i = D({}), { t: r } = e.i18n, a = j(n.path), u = t, c = D(null);
    re(() => {
    ...
    return (d, f) => {
      ...
      return v(), h("ul", {
        ...
        (v(!0), h(ie, null, ce(_.value, (y) => (v(), h("li", {
          ...
          o("div", Ee(Ne(l(s).events({ ...y, type: "dir" }), !0), { class: "vuefinder__treesubfolderlist__item-content" }), [
            o("div", {
            ...
            o("div", {
              ...
              onClick: (E) => l(e).adapter.open(y.path)
            }, [
              o("div", Lf, [
  ...
  setup(t) {
    const e = J("ServiceContainer"), n = e.fs, s = D(!1), i = t, r = _t(e, ["vuefinder__drag-over"]), a = j(n.path), u = G(() => i.storage === a.value?.storage), c = {
      storage: i.storage,
      path: i.storage + "://",
      type: "dir",
      basename: i.storage,
  ...
  __name: "TreeView",
  setup(t) {
    const e = J("ServiceContainer"), { t: n } = e.i18n, { getStore: s, setStore: i } = e.storage, r = e.fs, a = e.config, u = j(a.state), c = j(r.sortedFiles), _ = j(r.storages), d = j(r.path), f = _t(e, ["vuefinder__drag-over"]), g = D(190), y = D(s("pinned-folders-opened", !0));
            ...
            y.value ? (v(), h("ul", jf, [
              (v(!0), h(ie, null, ce(l(u).pinnedFolders, (w) => (v(), h("li", {
                ...
                o("div", {
                  ...
                  L(l(Df), { class: "vuefinder__treeview__remove-icon" })
                ], 8, Yf)
              ]))), 128)),
...
const e_ = [
  ...
  setup(t, { emit: e }) {
    const n = e, s = t, i = Uo(s, J("VueFinderOptions") || {});
