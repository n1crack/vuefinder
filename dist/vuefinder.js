...
import { ref as I, watch as Ye, provide as qe, reactive as he, onMounted as fe, resolveComponent as R, openBlock as x, createElementBlock as P, normalizeClass as ae, createElementVNode as i, unref as j, createVNode as X, createBlock as q, resolveDynamicComponent as Zt, createCommentVNode as W, createStaticVNode as Yt, withDirectives as G, Fragment as Q, renderList as ee, toDisplayString as z, vModelSelect as Jt, vShow as Se, withModifiers as de, createTextVNode as ge, nextTick as Je, withKeys as le, renderSlot as We, withCtx as N, vModelText as ve, normalizeStyle as Xt } from "vue";
const Gt = (y, { method: f = "get", params: a = {} }) => {
  const p = { method: f };
  return f == "get" ? y += "?" + new URLSearchParams(a) : p.body = a, fetch(y, p).then((d) => d.json());
};
function Qt(y) {
  return { all: y = y || /* @__PURE__ */ new Map(), on: function(f, a) {
    var p = y.get(f);
    p ? p.push(a) : y.set(f, [a]);
  }, off: function(f, a) {
    var p = y.get(f);
    p && (a ? p.splice(p.indexOf(a) >>> 0, 1) : y.set(f, []));
  }, emit: function(f, a) {
    var p = y.get(f);
    p && p.slice().map(function(d) {
      d(a);
    }), (p = y.get("*")) && p.slice().map(function(d) {
      d(f, a);
    });
  } };
}
function Ze(y) {
  let f = localStorage.getItem(y + "_storage");
  const a = I(JSON.parse(f));
  Ye(a, p);
  function p() {
    a.value === null || a.value === "" ? localStorage.removeItem(y + "_storage") : localStorage.setItem(y + "_storage", JSON.stringify(a.value));
  }
  function d(b, _) {
    a.value = Object.assign({ ...a.value }, { [b]: _ });
  }
  function n() {
    a.value = null;
  }
  return { getStore: (b, _ = null) => a.value === null || a.value === "" ? _ : a.value.hasOwnProperty(b) ? a.value[b] : _, setStore: d, clearStore: n };
}
const er = {
  name: "VueFinder"
  ...
  setup(y) {
    const f = y, a = Qt();
    qe("emitter", a);
    const { setStore: p, getStore: d } = Ze(f.id);
    qe("storage", Ze(f.id));
    const n = he({ adapter: "local", storages: [], dirname: ".", files: [] }), D = I(d("viewport", "grid")), b = I(d("darkMode", f.dark));
    a.on("vf-darkMode-toggle", () => {
      b.value = !b.value, p("darkMode", b.value);
    ...
    a.on("vf-modal-close", () => {
      ...
      _.active = !0, _.type = w.type, _.data = w;
    });
    const g = (w) => {
      Object.assign(n, w), a.emit("vf-nodes-selected", {}), a.emit("vf-explorer-update", w);
    };
    return a.on("vf-fetch", (w) => {
      Gt(f.url, { params: w }).then((S) => {
        a.emit("vf-modal-close"), g(S);
      });
    }), fe(() => {
      a.emit("vf-fetch", { q: "index", adapter: d("adapter", n.adapter) });
    }), (w, S) => {
      ...
      return x(), P("div", {
        ...
        i("div", {
          ...
          X(A),
          X(B, { data: n }, null, 8, ["data"]),
          X(K, {
            view: D.value,
            data: n
          }, null, 8, ["view", "data"]),
          X(E, { data: n }, null, 8, ["data"])
        ], 32),
        _.active ? (x(), q(Zt("v-f-modal-" + _.type), {
          key: 0,
          selection: _.data,
          current: n
        }, null, 8, ["selection", "current"])) : W("", !0),
        X(te, { current: n }, null, 8, ["current"])
      ], 2);
    };
  }
}), rr = { class: "border-neutral-300 flex justify-between items-center py-1 text-sm" }, or = { class: "flex text-center" }, nr = /* @__PURE__ */ i("path", {
  ...
  setup(y) {
    const f = inject("emitter"), { getStore: a, setStore: p } = inject("storage"), d = I(a("viewport", "grid")), n = I([]);
    return f.on("vf-nodes-selected", (D) => {
      n.value = D;
    }), f.on("vf-view-toggle", (D) => {
      p("viewport", D), d.value = D;
    }), (D, b) => (x(), P("div", rr, [
      i("div", or, [
        i("div", {
          class: "mx-1.5",
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[0] || (b[0] = (_) => n.value.length != 1 || j(f).emit("vf-modal-show", { type: "rename", items: n.value }))
        }, [
          (x(), P("svg", {
            xmlns: "http://www.w3.org/2000/svg",
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[1] || (b[1] = (_) => !n.value.length || j(f).emit("vf-modal-show", { type: "delete", items: n.value }))
        }, [
          (x(), P("svg", {
            xmlns: "http://www.w3.org/2000/svg",
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[2] || (b[2] = (_) => j(f).emit("vf-modal-show", { type: "new-folder", items: n.value }))
        }, cr),
        i("div", {
          class: "mx-1.5",
          "aria-label": "New File",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[3] || (b[3] = (_) => j(f).emit("vf-modal-show", { type: "new-file", items: n.value }))
        }, dr),
        i("div", {
          class: "mx-1.5",
          "aria-label": "Upload",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[4] || (b[4] = (_) => j(f).emit("vf-modal-show", { type: "message", title: "Custom modal", message: "Custom title" }))
        }, hr),
        i("div", {
          class: "mx-1.5",
          "aria-label": "Zip",
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[5] || (b[5] = (_) => !n.value.length || j(f).emit("vf-modal-show", { type: "zip", items: n.value }))
        }, [
          (x(), P("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: ae([n.value.length ? "cursor-pointer stroke-gray-800 hover:stroke-cyan-700 dark:stroke-gray-300 dark:hover:stroke-gray-100" : "stroke-gray-200  dark:stroke-gray-600", "h-6 w-6 md:h-8 md:w-8 m-auto"]),
      ...
      i("div", vr, [
        i("div", pr, [
          (x(), P("svg", {
            onClick: b[6] || (b[6] = (_) => j(f).emit("vf-darkMode-toggle")),
            viewBox: "0 0 24 24",
            "stroke-width": "2",
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
        ...
        i("div", {
          ...
          "data-microtip-position": "bottom",
          role: "tooltip",
          onClick: b[7] || (b[7] = (_) => j(f).emit("vf-view-toggle", d.value == "list" ? "grid" : "list"))
        }, [
  ...
  setup(y) {
    var _;
    const f = y, a = inject("emitter"), { getStore: p, setStore: d } = inject("storage"), n = I(0), D = I((_ = p("adapter")) != null ? _ : f.data.adapter), b = () => {
    ...
    return a.on("vf-nodes-selected", (g) => {
      ...
      i("div", Mr, [
        ...
        G(i("select", {
          ...
          (x(!0), P(Q, null, ee(y.data.storages, (S) => (x(), P("option", { value: S }, z(S), 9, Ar))), 256))
        ], 544), [
          [Jt, D.value]
        ]),
        i("span", Er, z(n.value > 0 ? n.value + " items selected." : ""), 1)
      ]),
      i("div", Tr, [
        i("span", {
...
var zr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xe = { exports: {} };
(function(y, f) {
  (function(a, p) {
    y.exports = p();
  })(zr, function() {
    ...
    function b(o) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2 ? D(Object(e), !0).forEach(function(s) {
          n(o, s, e[s]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(e)) : D(Object(e)).forEach(function(s) {
    ...
    function te(o, t) {
      return t && (typeof t == "object" || typeof t == "function") ? t : E(o);
    }
    function re(o) {
      var t = S();
      return function() {
    ...
    function xe(o, t) {
      for (; !Object.prototype.hasOwnProperty.call(o, t) && (o = g(o), o !== null); )
        ;
      return o;
    }
    function $(o, t, e) {
    ...
    function T(o, t) {
      return L(o) || Y(o, t) || ke(o, t) || Qe();
    }
    function C(o) {
      return U(o) || Z(o) || ke(o) || Ge();
    }
    function U(o) {
      if (Array.isArray(o))
        return pe(o);
    ...
    function Y(o, t) {
      if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(o)))) {
        ...
        try {
          for (var c = o[Symbol.iterator](), u; !(s = (u = c.next()).done) && (e.push(u.value), !(t && e.length === t)); s = !0)
            ;
        } catch (m) {
          r = !0, l = m;
        } finally {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var H = function(t, e, s) {
      ...
      var t = o.shiftKey, e = o.keyboardDragSpeed, s = o.zoom, r = o.key, l = o.dragKeys, c = o.scrollDiff, u = o.canScroll, m = o.scrollCallback, v = {
        x: 0,
        y: 0
      }, h = t ? e * 4 * s : e * s;
      return l.left.includes(r) && (v.x = c.x || -h, !t && !c.x && u && m(["left"], e)), l.right.includes(r) && (v.x = c.x || h, !t && !c.x && u && m(["right"], e)), l.up.includes(r) && (v.y = c.y || -h, !t && !c.y && u && m(["top"], e)), l.down.includes(r) && (v.y = c.y || h, !t && !c.y && u && m(["bottom"], e)), v;
    }, ft = function(o) {
      ...
      var t = o.element, e = o.posDirection, s = o.containerRect, r = o.useTransform, l = dt(t, r), c = H(l, "+", e);
      ie(t, c, r);
      ...
      return o ? !Array.isArray(o) && (o instanceof HTMLElement || o instanceof SVGElement) ? [o] : C(o) : [];
    }, je = function(o, t) {
      ...
      function o(t) {
        ...
        }), n(this, "handleZIndex", function(h) {
          e._elements.forEach(function(k) {
            return k.style.zIndex = "".concat((parseInt(k.style.zIndex) || 0) + h ? 9999 : -9998);
          });
      ...
      function o(t) {
        ...
        a(this, o), n(this, "_areaElement", void 0), n(this, "_draggability", void 0), n(this, "_immediateDrag", void 0), n(this, "_selectableClass", void 0), n(this, "isInteracting", void 0), n(this, "isDragging", void 0), n(this, "init", function() {
          ...
          if (!!e._canInteract(v) && !(v.detail > 0)) {
            var h = e.DS, k = h.stores, M = k.PointerStore, V = k.KeyStore, F = h.SelectableSet, O = h.SelectedSet;
            M.start(v);
            var se = v.target;
          ...
          var v = m.event, h = m.scroll_directions, k = m.scroll_multiplier;
    ...
    }, xt = /* @__PURE__ */ function(o) {
      _(e, o);
      var t = re(e);
      function e(s) {
        var r, l = s.elements, c = s.className, u = s.hoverClassName, m = s.draggability, v = s.useTransform, h = s.DS;
        return a(this, e), r = t.call(this), n(E(r), "_initElements", void 0), n(E(r), "_className", void 0), n(E(r), "_hoverClassName", void 0), n(E(r), "_useTransform", void 0), n(E(r), "_draggability", void 0), n(E(r), "init", function() {
          return r._initElements.forEach(function(k) {
            return r.add(k);
          });
        }), n(E(r), "clear", function() {
          return r.forEach(function(k) {
            return r.delete(k);
          });
        }), n(E(r), "_onClick", function(k) {
          return r.DS.publish(["Selectable:click:pre", "Selectable:click"], {
            event: k
          });
        }), n(E(r), "_onPointer", function(k) {
          return r.DS.publish(["Selectable:pointer:pre", "Selectable:pointer"], {
            event: k
          });
        }), n(E(r), "addAll", function(k) {
          return k.forEach(function(M) {
            return r.add(M);
          });
        }), n(E(r), "deleteAll", function(k) {
          return k.forEach(function(M) {
            return r.delete(M);
          });
        }), r.DS = h, r._initElements = ne(l), r._className = c, r._hoverClassName = u, r._useTransform = v, r._draggability = m, r.DS.subscribe("Interaction:init", r.init), r;
      }
      return d(e, [{
        key: "add",
        value: function(r) {
    ...
    }(/* @__PURE__ */ K(Set)), kt = /* @__PURE__ */ function(o) {
      _(e, o);
      var t = re(e);
      function e(s) {
        var r, l = s.className, c = s.DS;
        return a(this, e), r = t.call(this), n(E(r), "_className", void 0), n(E(r), "clear", function() {
          return r.forEach(function(u) {
            return r.delete(u);
          });
        }), n(E(r), "addAll", function(u) {
          return u.forEach(function(m) {
            return r.add(m);
          });
        }), n(E(r), "deleteAll", function(u) {
          return u.forEach(function(m) {
            return r.delete(m);
          });
      ...
      function o(t) {
        ...
        a(this, o), n(this, "_prevSelectedSet", void 0), n(this, "_hoverClassName", void 0), n(this, "_multiSelectToggling", void 0), n(this, "start", function(c) {
          ...
          for (var m = e.DS, v = m.SelectableSet, h = m.SelectorArea, k = m.Selector, M = v.elements.map(function(J) {
            return [J, J.getBoundingClientRect()];
          }), V = [], F = [], O = 0, se = M.length; O < se; O++)
            !h.isInside(M[O][0], M[O][1]) || (be(M[O][1], k.rect) ? V.push(M[O][0]) : F.push(M[O][0]));
          var ue = e.DS.stores.KeyStore.isMultiSelectKeyPressed(u) && e._multiSelectToggling;
          e.DS.continue || (V.forEach(function(J) {
            return ft({
              element: J,
              force: c,
      ...
      function o(t) {
        ...
        a(this, o), n(this, "_rect", void 0), n(this, "start", function(u) {
          ...
          if (!m) {
            ...
            je(e.HTMLNode, De(h, 1)), e.HTMLNode.style.display = "block", e._rect = null;
          }
        }), n(this, "stop", function() {
          ...
          var m = u.isDragging;
          if (!(m || e.DS.continue)) {
            var v = e.DS.stores, h = v.ScrollStore, k = v.PointerStore, M = lt({
        ...
        }), this.DS = s, this.HTMLNode = r || nt(c), this.HTMLNode.classList.add(l), this.DS.subscribe("Interaction:start", this.start), this.DS.subscribe("Interaction:update", this.update), this.DS.subscribe("Interaction:end", this.stop);
      }
      return d(o, [{
        key: "rect",
        get: function() {
      ...
      function o(t) {
        ...
        a(this, o), n(this, "_autoScrollSpeed", void 0), n(this, "_scrollInterval", void 0), n(this, "_rect", void 0), n(this, "currentEdges", []), n(this, "_overflowTolerance", void 0), n(this, "start", function() {
          ...
          e._rect = null;
          var u = e.DS.Area.rect, m = e.DS.Area.computedBorder, v = e.HTMLNode.style, h = "".concat(u.top + m.top, "px"), k = "".concat(u.left + m.left, "px"), M = "".concat(u.width, "px"), V = "".concat(u.height, "px");
          v.top !== h && (v.top = h), v.left !== k && (v.left = k), v.width !== M && (v.width = M), v.height !== V && (v.height = V);
      ...
      return d(o, [{
        ...
        set: function(e) {
          this._initialVal = e, this._initialValArea = e && H(e, "-", H(oe(this.DS.Area.rect), "+", oe(this.DS.Area.computedBorder)));
        }
      }, {
        key: "currentVal",
        get: function() {
        ...
        set: function(e) {
          this._currentVal = e, this._currentValArea = e && H(e, "-", H(oe(this.DS.Area.rect), "+", oe(this.DS.Area.computedBorder)));
        }
      }, {
        key: "lastVal",
        get: function() {
        ...
        set: function(e) {
          this._lastVal = e, this._lastValArea = e && H(e, "-", H(oe(this.DS.Area.rect), "+", oe(this.DS.Area.computedBorder)));
        }
      }]), o;
      ...
      function o(t) {
        var e = this, s = t.area, r = s === void 0 ? document : s, l = t.selectables, c = l === void 0 ? [] : l, u = t.autoScrollSpeed, m = u === void 0 ? 5 : u, v = t.overflowTolerance, h = v === void 0 ? {
          x: 25,
          y: 25
        } : v, k = t.zoom, M = k === void 0 ? 1 : k, V = t.customStyles, F = V === void 0 ? !1 : V, O = t.multiSelectMode, se = O === void 0 ? !1 : O, ue = t.multiSelectToggling, J = ue === void 0 ? !0 : ue, Ae = t.multiSelectKeys, Et = Ae === void 0 ? ["Control", "Shift", "Meta"] : Ae, Ee = t.selector, Tt = Ee === void 0 ? void 0 : Ee, Te = t.draggability, _e = Te === void 0 ? !0 : Te, Ie = t.immediateDrag, It = Ie === void 0 ? !0 : Ie, Ve = t.keyboardDrag, Vt = Ve === void 0 ? !0 : Ve, Lt = t.dragKeys, Le = t.keyboardDragSpeed, Ot = Le === void 0 ? 10 : Le, Oe = t.useTransform, ze = Oe === void 0 ? !0 : Oe, Ne = t.hoverClass, Ke = Ne === void 0 ? "ds-hover" : Ne, Be = t.selectableClass, He = Be === void 0 ? "ds-selectable" : Be, Re = t.selectedClass, zt = Re === void 0 ? "ds-selected" : Re, Fe = t.selectorClass, Nt = Fe === void 0 ? "ds-selector" : Fe, Ue = t.selectorAreaClass, Kt = Ue === void 0 ? "ds-selector-area" : Ue, Bt = t.callback, Ht = t.onDragMove, Rt = t.onDragStartBegin, Ft = t.onDragStart, Ut = t.onElementSelect, qt = t.onElementUnselect;
        ...
        }), n(this, "isMultiSelect", function(Wt) {
      ...
      return d(o, [{
        ...
        value: function(e) {
          ...
          s && (v("callback", "callback"), this.subscribe("callback", function(h) {
            var k = h.items;
            h.item;
            var M = h.event;
            return s(k, M);
            ...
            var k = h.event;
            return r(k);
          })), l && (v("onDragStart", "dragstart"), this.subscribe("dragstart", function(h) {
            h.items, h.item;
            var k = h.event;
            return l(k);
          })), c && (v("onDragStartBegin", "dragstart"), this.subscribe("dragstart", function(h) {
            h.items, h.item;
            var k = h.event;
            return c(k);
          })), u && (v("onElementSelect", "elementselect"), this.subscribe("elementselect", function(h) {
            h.items;
            var k = h.item, M = h.event;
            return u(k, M);
          })), m && (v("onElementUnselect", "elementunselect"), this.subscribe("elementunselect", function(h) {
            h.items;
            var k = h.item, M = h.event;
            return m(k, M);
          }));
...
const Nr = Xe.exports, Kr = (y, f, a, p, d) => (f = Math, a = f.log, p = 1024, d = a(y) / a(p) | 0, y / f.pow(p, d)).toFixed(0) + " " + (d ? "KMGTPEZY"[--d] + "iB" : "B"), Br = (y, f = "en-US") => new Date(y * 1e3).toLocaleString(f), Hr = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5",
  viewBox: "0 0 20 20",
  ...
  name: "VFSortIcon"
}, me = /* @__PURE__ */ Object.assign(Zr, {
  props: { direction: String },
  setup(y) {
    return (f, a) => (x(), P("div", null, [
      y.direction == "down" ? (x(), P("svg", Hr, Fr)) : W("", !0),
      y.direction == "up" ? (x(), P("svg", Ur, Wr)) : W("", !0)
    ]));
  }
}), Yr = { class: "relative h-full" }, Jr = {
  key: 0,
  class: "grid grid-cols-12 border-b border-neutral-300 dark:border-gray-700 text-xs select-none"
}, Xr = /* @__PURE__ */ ge(" Name "), Gr = /* @__PURE__ */ ge(" Size "), Qr = /* @__PURE__ */ ge(" Date "), eo = ["onDblclick", "onContextmenu", "onDragstart", "onDragover", "onDrop", "data-type", "data-item", "data-index"], to = { class: "grid grid-cols-12 items-center" }, ro = { class: "flex col-span-7 items-center" }, oo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  ...
  ao
], co = { class: "overflow-ellipsis overflow-hidden whitespace-nowrap" }, uo = { class: "col-span-2 text-center" }, mo = { class: "col-span-3 overflow-ellipsis overflow-hidden whitespace-nowrap" }, ho = ["onDblclick", "onContextmenu", "onDragstart", "onDragover", "onDrop", "data-type", "data-item", "data-index"], fo = { class: "relative" }, go = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  ...
  bo
], So = { class: "absolute hidden md:block top-1/2 w-full text-center text-neutral-500" }, wo = { class: "break-all" }, xo = { class: "absolute top-[-200px] left-[-200px]" }, ko = /* @__PURE__ */ i("svg", {
  xmlns: "http://www.w3.org/2000/svg",
...
], -1), Do = { class: "text-neutral-700 dark:text-neutral-300 p-1 absolute text-center top-4 right-[-2rem] md:top-5 md:right-[-2.4rem] z-20 text-xs" }, $o = {
  name: "VFExplorer"
}, Co = /* @__PURE__ */ Object.assign($o, {
  props: {
    view: String,
    data: Object
  },
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = ($) => $ == null ? void 0 : $.substring(0, 3), n = ($) => $.replace(/((?=([\w\W]{0,14}))([\w\W]{8,})([\w\W]{8,}))/, "$2..$4"), D = I(null), b = I(null), _ = I(0), g = I(null), w = ($) => {
      $.type == "dir" ? a.emit("vf-fetch", { q: "index", adapter: f.data.adapter, path: $.path }) : a.emit("vf-modal-show", { type: "preview" });
    }, S = he({ active: !1, column: "", order: "" }), A = ($ = !0) => {
      let T = [...f.data.files], C = S.column, U = S.order == "asc" ? 1 : -1;
      if (!$)
        return T;
      const L = (Z, Y) => typeof Z == "string" && typeof Y == "string" ? Z.toLowerCase().localeCompare(Y.toLowerCase()) : Z < Y ? -1 : Z > Y ? 1 : 0;
      return S.active && (T = T.slice().sort((Z, Y) => L(Z[C], Y[C]) * U)), T;
    }, B = ($) => {
      ...
      if (C.find((U) => U.storage != p("adapter"))) {
    ...
    return fe(() => {
      g.value = new Nr({
        ...
        if (T)
          _.value = g.value.getSelection().length, g.value.break();
        else {
        ...
        a.emit("vf-nodes-selected", K()), _.value = g.value.getSelection().length;
      });
    }), fe(() => {
      Ye(() => f.view, () => a.emit("vf-explorer-update"));
    }), ($, T) => (x(), P("div", Yr, [
      y.view == "list" ? (x(), P("div", Jr, [
        i("div", {
        ...
        i("div", {
          ...
          G(X(me, {
            ...
            [Se, S.active && S.column == "file_size"]
          ])
        ]),
        i("div", {
          ...
          G(X(me, {
            ...
            [Se, S.active && S.column == "last_modified"]
          ])
        ])
      ])) : W("", !0),
      i("div", {
        ...
        y.view == "list" ? (x(!0), P(Q, { key: 0 }, ee(A(), (C, U) => (x(), P("div", {
          draggable: "true",
          onDblclick: (L) => w(C),
          ...
          i("div", to, [
            i("div", ro, [
              C.type == "dir" ? (x(), P("svg", oo, so)) : (x(), P("svg", io, lo)),
              i("span", co, z(C.basename), 1)
            ]),
            i("div", uo, z(C.file_size ? j(Kr)(C.file_size) : ""), 1),
            i("div", mo, z(j(Br)(C.last_modified)), 1)
          ])
        ], 40, eo))), 256)) : W("", !0),
        y.view == "grid" ? (x(!0), P(Q, { key: 1 }, ee(A(!1), (C, U) => (x(), P("div", {
          draggable: "true",
          onDblclick: (L) => w(C),
          onContextmenu: de((L) => j(a).emit("vf-contextmenu-show", { event: L, area: D.value, items: K(), target: C }), ["prevent"]),
          onDragstart: (L) => E(L),
          ...
          i("div", null, [
            i("div", fo, [
              C.type == "dir" ? (x(), P("svg", go, po)) : (x(), P("svg", yo, _o)),
              i("div", So, z(d(C.extension)), 1)
            ]),
            i("span", wo, z(n(C.basename)), 1)
          ])
        ], 40, ho))), 256)) : W("", !0),
        i("div", xo, [
          i("div", {
            ...
            ko,
            i("div", Do, z(_.value), 1)
          ], 512)
        ])
      ], 544)
    ]));
  }
}), Po = { class: "flex p-1.5 bg-neutral-100 dark:bg-gray-800 border-t border-b border-neutral-300 dark:border-gray-700/50 items-center select-none" }, Mo = /* @__PURE__ */ i("path", {
  "fill-rule": "evenodd",
  d: "M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z",
  "clip-rule": "evenodd"
}, null, -1), jo = [
  Mo
], Ao = { class: "flex bg-white dark:bg-gray-700 items-center rounded p-1 ml-2 w-full" }, Eo = /* @__PURE__ */ i("path", { d: "M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" }, null, -1), To = [
  Eo
], Io = { class: "flex leading-5" }, Vo = /* @__PURE__ */ i("span", { class: "text-neutral-300 dark:text-gray-600 mx-0.5" }, "/", -1), Lo = ["title", "onClick"], Oo = {
  name: "VFBreadcrumb"
  ...
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = I(null), n = I([]);
    a.on("vf-explorer-update", (_) => {
      var S;
      let g = [], w = [];
      d.value = (S = f.data.dirname) != null ? S : "", d.value.length == 0 && (n.value = []), d.value.split("/").forEach(function(A) {
      ...
      }), w.length > 4 && (w = w.slice(-5), w[0].name = ".."), n.value = w;
    });
    const D = (_) => {
      var w;
      _.preventDefault();
      let g = JSON.parse(_.dataTransfer.getData("items"));
      if (g.find((S) => S.storage != p("adapter"))) {
        alert("Moving items between different storages is not supported yet.");
        return;
      }
      a.emit("vf-modal-show", {
        type: "move",
        items: { from: g, to: (w = n.value[n.value.length - 2]) != null ? w : { path: "/" } }
      });
    }, b = (_) => {
      _.preventDefault(), n.value.length < 1 && (_.dataTransfer.dropEffect = "none", _.dataTransfer.effectAllowed = "none");
    };
    return (_, g) => (x(), P("div", Po, [
      (x(), P("svg", {
        onDragover: g[0] || (g[0] = (w) => b(w)),
        onDrop: g[1] || (g[1] = (w) => D(w)),
        onClick: g[2] || (g[2] = (w) => {
          var S, A;
          return !n.value.length || j(a).emit("vf-fetch", { q: "index", adapter: y.data.adapter, path: (A = (S = n.value[n.value.length - 2]) == null ? void 0 : S.path) != null ? A : "" });
        }),
      ...
      i("div", Ao, [
        (x(), P("svg", {
          onClick: g[3] || (g[3] = (w) => j(a).emit("vf-fetch", { q: "index", adapter: y.data.adapter })),
        ...
        i("div", Io, [
          (x(!0), P(Q, null, ee(n.value, (w, S) => (x(), P("div", { key: S }, [
            Vo,
            i("span", {
              class: "px-1.5 py-1 text-slate-700 dark:text-slate-200 hover:bg-neutral-100 dark:hover:bg-gray-800 rounded cursor-pointer",
              title: w.basename,
              onClick: (A) => j(a).emit("vf-fetch", { q: "index", adapter: y.data.adapter, path: w.path })
            }, z(w.name), 9, Lo)
          ]))), 128))
        ])
      ])
...
}), No = /* @__PURE__ */ i("div", { class: "fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" }, null, -1), Ko = { class: "fixed z-10 inset-0 overflow-y-auto" }, Bo = { class: "relative bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full" }, Ho = { class: "bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4" }, Ro = { class: "bg-gray-50 dark:bg-gray-800 dark:border-t dark:border-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse" }, Fo = {
  name: "VFModal"
}, Uo = /* @__PURE__ */ Object.assign(Fo, {
  setup(y) {
    const f = inject("emitter");
    return fe(() => {
      ...
      role: "dialog",
      "aria-modal": "true",
      onKeyup: p[1] || (p[1] = le((d) => j(f).emit("vf-modal-close"), ["esc"])),
      tabindex: "0"
    }, [
      No,
      i("div", Ko, [
        i("div", {
          ...
          onClick: p[0] || (p[0] = de((d) => j(f).emit("vf-modal-close"), ["self"]))
        }, [
          i("div", Bo, [
            i("div", Ho, [
              We(a.$slots, "default")
...
}), qo = { class: "sm:flex sm:items-start" }, Wo = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
...
], -1), Zo = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, Yo = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "Delete files", -1), Jo = { class: "mt-2" }, Xo = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, [
  /* @__PURE__ */ ge("Are you sure you want to delete these files? "),
  /* @__PURE__ */ i("span", { class: "font-bold text-red-500 dark:text-red-200" }, "This action cannot be undone.")
], -1), Go = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, Qo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = I(f.selection.items), n = () => {
      d.value.length && a.emit("vf-fetch", {
        q: "delete",
        adapter: p("adapter"),
        path: f.current.dirname,
        ...
        default: N(() => [
          i("div", qo, [
            ...
            i("div", Zo, [
              ...
              i("div", Jo, [
                Xo,
                (x(!0), P(Q, null, ee(d.value, (g) => (x(), P("p", Go, [
                  g.type == "dir" ? (x(), P("svg", Qo, tn)) : (x(), P("svg", rn, nn)),
                  i("span", sn, z(g.basename), 1)
                ]))), 256))
              ])
            ])
          ])
...
}), cn = { class: "sm:flex sm:items-start" }, un = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-50 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    xmlns: "http://www.w3.org/2000/svg",
...
], -1), dn = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, mn = {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, hn = { class: "mt-2" }, fn = { class: "text-sm text-gray-500" }, gn = {
  name: "VFModalMessage"
    ...
    return (a, p) => {
      ...
      return x(), q(d, null, {
        buttons: N(() => [
          i("button", {
            type: "button",
            onClick: p[0] || (p[0] = (n) => j(f).emit("vf-modal-close")),
            class: "mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          }, "Close")
        ]),
        default: N(() => {
          ...
          return [
            i("div", cn, [
              un,
              i("div", dn, [
                i("h3", mn, z((D = (n = y.item) == null ? void 0 : n.title) != null ? D : "Title"), 1),
                i("div", hn, [
                  i("p", fn, z((_ = (b = y.item) == null ? void 0 : b.message) != null ? _ : "Message") + ".", 1)
                ])
              ])
            ])
          ];
...
}), pn = { class: "sm:flex sm:items-start" }, yn = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), bn = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, _n = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "New Folder", -1), Sn = { class: "mt-2" }, wn = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, "Create a new folder", -1), xn = ["onKeyup"], kn = {
  ...
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = I(""), n = () => {
...
}), $n = { class: "sm:flex sm:items-start" }, Cn = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), Pn = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, Mn = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "New File", -1), jn = { class: "mt-2" }, An = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500" }, "Create a new file", -1), En = ["onKeyup"], Tn = {
  name: "VFModalNewFile"
...
}), Vn = /* @__PURE__ */ i("div", { class: "sm:flex sm:items-start" }, [
...
}), Nn = { class: "sm:flex sm:items-start" }, Kn = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), Bn = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, Hn = {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, Rn = { class: "mt-2" }, Fn = { class: "flex text-sm text-gray-800 dark:text-gray-400 py-2" }, Un = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  Yn
], Xn = { class: "ml-1.5" }, Gn = ["onKeyup"], Qn = {
  name: "VFModalRename"
}, es = /* @__PURE__ */ Object.assign(Qn, {
  props: {
    selection: Object,
    current: Object
  },
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = I(f.selection.items[0]), n = I(f.selection.items[0].basename), D = () => {
    ...
    return (b, _) => {
      ...
      return x(), q(g, null, {
        buttons: N(() => [
          ...
          i("button", {
            type: "button",
            onClick: _[1] || (_[1] = (w) => j(a).emit("vf-modal-close")),
            class: "mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          }, "Cancel")
        ]),
        default: N(() => [
          i("div", Nn, [
            Kn,
            i("div", Bn, [
              i("h3", Hn, "Rename your " + z(d.value.type == "dir" ? "folder" : "file"), 1),
              i("div", Rn, [
                i("p", Fn, [
                  d.value.type == "dir" ? (x(), P("svg", Un, Wn)) : (x(), P("svg", Zn, Jn)),
                  i("span", Xn, z(d.value.basename), 1)
                ]),
                G(i("input", {
                  "onUpdate:modelValue": _[0] || (_[0] = (w) => n.value = w),
                  onKeyup: le(D, ["enter"]),
                  class: "px-2 py-1 border rounded dark:bg-gray-500 dark:focus:ring-gray-600 dark:focus:border-gray-600 dark:text-gray-100 w-full",
                  placeholder: "Name",
                  type: "text"
...
}), ts = /* @__PURE__ */ i("div", { class: "sm:flex sm:items-start" }, [
  /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
    /* @__PURE__ */ i("svg", {
      class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
      xmlns: "http://www.w3.org/2000/svg",
...
}), ss = { class: "sm:flex sm:items-start" }, is = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), as = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full" }, ls = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "Archive files", -1), cs = { class: "mt-2" }, us = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, ds = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  gs
], ps = { class: "ml-1.5" }, ys = /* @__PURE__ */ i("p", { class: "my-1 text-sm text-gray-500" }, "Archive name. (.zip file will be created)", -1), bs = ["onKeyup"], _s = {
  name: "VFModalZip"
  ...
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = I(""), n = I(f.selection.items), D = () => {
      n.value.length && a.emit("vf-fetch", {
        q: "zip",
        adapter: p("adapter"),
        path: f.current.dirname,
        items: JSON.stringify(n.value.map(({ path: b, type: _ }) => ({ path: b, type: _ }))),
        name: d.value
      });
    };
    return (b, _) => {
        ...
        default: N(() => [
          i("div", ss, [
            ...
            i("div", as, [
              ls,
              i("div", cs, [
                (x(!0), P(Q, null, ee(n.value, (w) => (x(), P("p", us, [
                  w.type == "dir" ? (x(), P("svg", ds, hs)) : (x(), P("svg", fs, vs)),
                  i("span", ps, z(w.basename), 1)
                ]))), 256)),
                ys,
                G(i("input", {
...
}), ws = { class: "sm:flex sm:items-start" }, xs = /* @__PURE__ */ i("div", { class: "mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-gray-500 sm:mx-0 sm:h-10 sm:w-10" }, [
  /* @__PURE__ */ i("svg", {
    class: "h-6 w-6 stroke-red-600 dark:stroke-red-200",
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
], -1), ks = { class: "mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" }, Ds = /* @__PURE__ */ i("h3", {
  class: "text-lg leading-6 font-medium text-gray-900 dark:text-gray-400",
  id: "modal-title"
}, "Move files", -1), $s = { class: "mt-2" }, Cs = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, Ps = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  ...
  Es
], Is = { class: "ml-1.5" }, Vs = /* @__PURE__ */ i("p", { class: "text-sm text-gray-500 pb-1 pt-3" }, "Are you sure you want to move these files to ?", -1), Ls = { class: "flex text-sm text-gray-800 dark:text-gray-400" }, Os = /* @__PURE__ */ i("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  class: "h-5 w-5 text-neutral-500 fill-sky-500 stroke-sky-500 dark:fill-slate-500 dark:stroke-slate-500",
  fill: "none",
  viewBox: "0 0 24 24",
...
], -1), zs = { class: "ml-1.5 overflow-auto" }, Ns = {
  name: "VFModalMove"
}, Ks = /* @__PURE__ */ Object.assign(Ns, {
  props: {
    selection: Object,
    current: Object
  },
  setup(y) {
    const f = y, a = inject("emitter"), { getStore: p } = inject("storage"), d = I(f.selection.items.from), n = () => {
      d.value.length && a.emit("vf-fetch", {
        q: "move",
        adapter: p("adapter"),
        path: f.current.dirname,
        items: JSON.stringify(d.value.map(({ path: D, type: b }) => ({ path: D, type: b }))),
        item: f.selection.items.to.path
      });
    };
    return (D, b) => {
      const _ = R("v-f-modal");
        ...
        default: N(() => [
          i("div", ws, [
            ...
            i("div", ks, [
              Ds,
              i("div", $s, [
                (x(!0), P(Q, null, ee(d.value, (g) => (x(), P("p", Cs, [
                  g.type == "dir" ? (x(), P("svg", Ps, js)) : (x(), P("svg", As, Ts)),
                  i("span", Is, z(g.path), 1)
                ]))), 256)),
                Vs,
                i("p", Ls, [
                  Os,
                  i("span", zs, z(y.selection.items.to.path), 1)
                ])
              ])
            ])
          ])
...
}), Bs = ["onClick"], Hs = /* @__PURE__ */ i("span", { class: "px-1" }, null, -1), Rs = {
  name: "VFContextMenu"
}, Fs = /* @__PURE__ */ Object.assign(Rs, {
  props: {
    current: Object
  },
  setup(y) {
    const f = y, a = inject("emitter"), p = I(null), d = he({
      active: !1,
      items: [],
      positions: {
        left: 0,
    ...
    const D = {
      ...
      refresh: {
        title: "Refresh",
        action: () => {
          a.emit("vf-fetch", { q: "index", adapter: f.current.adapter, path: f.current.dirname });
        }
      },
      preview: {
        title: "Preview",
        action: () => {
          a.emit("vf-modal-show", { type: "preview" });
        }
      },
      zip: {
        title: "Zip",
        action: () => {
          a.emit("vf-modal-show", { type: "zip", items: n });
        }
      },
      rename: {
        title: "Rename",
    ...
    a.on("vf-contextmenu-show", ({ event: g, area: w, items: S, target: A = null }) => {
      d.items = [], A ? S.length > 1 && S.some((B) => B.path === A.path) ? (d.items.push(D.refresh), d.items.push(D.zip), d.items.push(D.delete), a.emit("vf-context-selected", S), console.log(S.length + " selected (more than 1 item.)")) : (d.items.push(D.refresh), d.items.push(D.preview), d.items.push(D.rename), d.items.push(D.zip), d.items.push(D.delete), a.emit("vf-context-selected", [A]), console.log(A.type + " is selected")) : (d.items.push(D.refresh), d.items.push(D.newfolder), a.emit("vf-context-selected", []), console.log("no files selected")), _(g, w);
    }), a.on("vf-contextmenu-hide", () => {
      d.active = !1;
    });
    const _ = (g, w) => {
      d.active = !0, Je(() => {
        let S = w.getBoundingClientRect(), A = g.pageX, B = g.pageY, K = p.value.offsetHeight, E = p.value.offsetWidth;
