...
const Oo = Tr.exports, Ar = (a, e, t, i, n) => (e = Math, t = e.log, i = 1024, n = t(a) / t(i) | 0, a / e.pow(i, n)).toFixed(0) + " " + (n ? "KMGTPEZY"[--n] + "iB" : "B"), Or = (a, e = null) => {
          ...
          return y(), C("div", {
            ...
            d("div", null, [
              d("div", ya, [
                ...
                !((oe = j.mime_type) != null ? oe : "").startsWith("image") && j.type != "dir" ? (y(), C("div", $a, E(o(j.extension)), 1)) : G("", !0)
              ]),
  ...
  value: "",
  disabled: ""
}, Ha = /* @__PURE__ */ d("option", { value: "en" }, "English", -1), Ua = /* @__PURE__ */ d("option", { value: "fr" }, "French", -1), Ka = /* @__PURE__ */ d("option", { value: "tr" }, "Turkish", -1), Ya = ["aria-label"], Wa = /* @__PURE__ */ d("svg", {
  xmlns: "http://www.w3.org/2000/svg",
