import { j as st, h as Q, N as v, T as it, g as Ee, J as Ie, o as H, H as ot, Q as m, f as fe, k as at, B as lt, x as ht, O as X, E as P, r as z, d as ft, z as ut, s as dt, b as pt, w as Me, y as ct, G as mt, c as gt, e as ue, P as kt } from "./CodeMirrorEditor-DPcTUWhC.js";
import { C as Lt } from "./index-B9bI9zyT.js";
import { html as bt, htmlCompletionSource as wt } from "./index-CT-JsU3N.js";
class U {
...
function or() {
  if (Y)
    return Y;
  let t = wt(new Lt(pt.create({ extensions: rt }), 0, !0));
  return Y = t ? t.options : [];
}
const ar = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i, lr = /* @__PURE__ */ gt.domEventHandlers({
  paste: (t, e) => {
    var r;
