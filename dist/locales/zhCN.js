...
export default {
  'A modern, customizable file manager component built for Vue.':
    '为 Vue 构建的现代、可自定义的文件管理器组件。',
  'Project Home': '项目主页',
  'If you like it, please follow and ⭐ star on GitHub.':
    '如果你喜欢，请关注并在 GitHub 上点 ⭐ 星标。',
  Language: '语言',
  Create: '创建',
  Close: '关闭',
  Cancel: '取消',
  ...
  'Name cannot contain slashes.': '名称不能包含斜杠。',
  'Zoom in': '放大',
  'Zoom out': '缩小',
  'Reset zoom': '重置缩放',
  'Sort by': '排序方式',
  ...
  'Showing first %s rows out of %s': '显示 %s 行中的前 %s 行',
  'Path copied to clipboard': '路径已复制到剪贴板',
  'Toggle Path Copy Mode': '切换路径复制模式',
  'Target folder': '目标文件夹',
  'No folders': '无文件夹',
  Pinned: '已固定',
  'Copy Path': '复制路径',
