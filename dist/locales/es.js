...
export default {
  ...
  'Failed to rename': 'Error al renombrar',
  'Name cannot contain slashes.': 'El nombre no puede contener barras.',
  'Zoom in': 'Acercar',
  'Zoom out': 'Alejar',
  ...
  'Name (A-Z)': 'Nombre (A-Z)',
  'Name (Z-A)': 'Nombre (Z-A)',
  'Size (smallest)': 'Tamaño (más pequeño)',
  'Size (largest)': 'Tamaño (más grande)',
  ...
  'View as raw': 'Ver sin procesar',
  'Failed to parse CSV': 'Error al analizar CSV',
  'No rows to display': 'No hay filas para mostrar',
  'Showing first %s rows out of %s': 'Mostrando las primeras %s filas de %s',
  'Path copied to clipboard': 'Ruta copiada al portapapeles',
  'Toggle Path Copy Mode': 'Alternar modo de copia de ruta',
