...
export default {
    ...
    "Vuefinder is a file manager component for vue 3.": "Vuefinder é um componente gerenciador de arquivos para Vue 3.",
    ...
    "Drag and drop the files/folders to here.": "Arraste e solte os arquivos/pastas aqui ou clique aqui.",
    "Release to drop these files.": "Solte para deixar cair estes arquivos.",
    "Canceled": "Cancelado",
    "Done": "Concluído",
    "Network Error, Unable establish connection to the server or interrupted.": "Erro de rede, Não foi possível estabelecer conexão com o servidor ou interrompido.",
    ...
    "Download doesn\'t work? You can try right-click \"Download\" button, select \"Save link as...\".": "O download não funciona? Você pode tentar clicar com o botão direito no botão \"Baixar\", selecionar \"Salvar link como...\".",
    "Theme": "Tema",
    "Dark": "Escuro",
    "Light": "Claro",
    "System": "Sistema",
