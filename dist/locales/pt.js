...
export default {
  ...
  'Name cannot contain slashes.': 'O nome não pode conter barras.',
  'Zoom in': 'Ampliar',
  'Zoom out': 'Reduzir',
  ...
  'Name (A-Z)': 'Nome (A-Z)',
  'Name (Z-A)': 'Nome (Z-A)',
  'Size (smallest)': 'Tamanho (menor)',
  'Size (largest)': 'Tamanho (maior)',
  'Date (newest)': 'Data (mais recente)',
  'Date (oldest)': 'Data (mais antiga)',
  'Preview as': 'Pré-visualizar como',
  Text: 'Texto',
  Image: 'Imagem',
  Table: 'Tabela',
  Raw: 'Bruto',
  'View as table': 'Visualizar como tabela',
  'View as raw': 'Visualizar como bruto',
  'Failed to parse CSV': 'Falha ao analisar CSV',
  'No rows to display': 'Sem linhas para exibir',
  'Showing first %s rows out of %s': 'Mostrando as primeiras %s linhas de %s',
  'Path copied to clipboard': 'Caminho copiado para a área de transferência',
  'Toggle Path Copy Mode': 'Alternar modo de cópia de caminho',
