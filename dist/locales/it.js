...
export default {
  ...
  'Persist Path': 'Mantieni percorso',
  'Metric Units': 'Unità metriche',
  ...
  'Failed to rename': 'Rinomina non riuscita',
  'Name cannot contain slashes.': 'Il nome non può contenere barre.',
  'Zoom in': 'Ingrandisci',
  'Zoom out': 'Riduci',
  ...
  'Name (A-Z)': 'Nome (A-Z)',
  'Name (Z-A)': 'Nome (Z-A)',
  'Size (smallest)': 'Dimensione (più piccola)',
  'Size (largest)': 'Dimensione (più grande)',
  'Date (newest)': 'Data (più recente)',
  'Date (oldest)': 'Data (più vecchia)',
  'Preview as': 'Anteprima come',
  Text: 'Testo',
  Image: 'Immagine',
  Table: 'Tabella',
  Raw: 'Grezzo',
  'View as table': 'Visualizza come tabella',
  'View as raw': 'Visualizza come grezzo',
  'Failed to parse CSV': 'Impossibile analizzare CSV',
  'No rows to display': 'Nessuna riga da visualizzare',
  'Showing first %s rows out of %s': 'Visualizzazione delle prime %s righe su %s',
  'Path copied to clipboard': 'Percorso copiato negli appunti',
  'Toggle Path Copy Mode': 'Attiva/disattiva modalità copia percorso',
