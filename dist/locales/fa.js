...
export default {
  ...
  'Persist Path': 'ذخیره مسیر',
  'Metric Units': 'واحد های متریک',
  ...
  'Failed to rename': 'تغییر نام ناموفق بود',
  'Name cannot contain slashes.': 'نام نمی‌تواند شامل اسلش باشد.',
  'Zoom in': 'بزرگ‌نمایی',
  'Zoom out': 'کوچک‌نمایی',
  ...
  'Name (A-Z)': 'نام (الف-ی)',
  'Name (Z-A)': 'نام (ی-الف)',
  'Size (smallest)': 'اندازه (کوچک‌ترین)',
  'Size (largest)': 'اندازه (بزرگ‌ترین)',
  'Date (newest)': 'تاریخ (جدیدترین)',
  'Date (oldest)': 'تاریخ (قدیمی‌ترین)',
  'Preview as': 'پیش‌نمایش به صورت',
  Text: 'متن',
  Image: 'تصویر',
  Table: 'جدول',
  Raw: 'خام',
  'View as table': 'نمایش به صورت جدول',
  'View as raw': 'نمایش به صورت خام',
  'Failed to parse CSV': 'تجزیه CSV ناموفق بود',
  'No rows to display': 'هیچ ردیفی برای نمایش وجود ندارد',
  'Showing first %s rows out of %s': 'نمایش %s ردیف اول از %s',
  'Path copied to clipboard': 'مسیر در کلیپ‌بورد کپی شد',
  'Toggle Path Copy Mode': 'تغییر حالت کپی مسیر',
  'Target folder': 'پوشه مقصد',
  'No folders': 'پوشه‌ای وجود ندارد',
  Pinned: 'سنجاق شده',
  'Copy Path': 'کپی مسیر',
