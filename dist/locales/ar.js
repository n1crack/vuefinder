...
export default {
  ...
  'Persist Path': 'البقاء على المسار',
  'Metric Units': 'وحدات القياس المتريّة',
  ...
  'Name cannot contain slashes.': 'لا يمكن أن يحتوي الاسم على شرطات مائلة.',
  'Zoom in': 'تكبير',
  'Zoom out': 'تصغير',
  ...
  'Name (A-Z)': 'الاسم (أ-ي)',
  'Name (Z-A)': 'الاسم (ي-أ)',
  'Size (smallest)': 'الحجم (الأصغر)',
  'Size (largest)': 'الحجم (الأكبر)',
  'Date (newest)': 'التاريخ (الأحدث)',
  'Date (oldest)': 'التاريخ (الأقدم)',
  'Preview as': 'معاينة كـ',
  Text: 'نص',
  Image: 'صورة',
  Table: 'جدول',
  Raw: 'خام',
  'View as table': 'العرض كجدول',
  'View as raw': 'العرض خامًا',
  'Failed to parse CSV': 'فشل في تحليل CSV',
  'No rows to display': 'لا توجد صفوف للعرض',
  'Showing first %s rows out of %s': 'عرض أول %s صفوف من أصل %s',
  'Path copied to clipboard': 'تم نسخ المسار إلى الحافظة',
  'Toggle Path Copy Mode': 'تبديل وضع نسخ المسار',
