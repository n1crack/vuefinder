...
export default {
  ...
  'Persist Path': 'पथ बनाए रखें',
  'Metric Units': 'मीट्रिक इकाइयां',
  ...
  'Failed to rename': 'नाम बदलने में विफल',
  'Name cannot contain slashes.': 'नाम में स्लैश नहीं हो सकता।',
  'Zoom in': 'ज़ूम इन',
  'Zoom out': 'ज़ूम आउट',
  ...
  'Name (A-Z)': 'नाम (A-Z)',
  'Name (Z-A)': 'नाम (Z-A)',
  'Size (smallest)': 'आकार (सबसे छोटा)',
  'Size (largest)': 'आकार (सबसे बड़ा)',
  'Date (newest)': 'दिनांक (सबसे नया)',
  'Date (oldest)': 'दिनांक (सबसे पुराना)',
  'Preview as': 'इस रूप में पूर्वावलोकन',
  Text: 'टेक्स्ट',
  Image: 'छवि',
  Table: 'तालिका',
  Raw: 'कच्चा',
  'View as table': 'तालिका के रूप में देखें',
  'View as raw': 'कच्चे रूप में देखें',
  'Failed to parse CSV': 'CSV पार्स करने में विफल',
  'No rows to display': 'दिखाने के लिए कोई पंक्ति नहीं',
  'Showing first %s rows out of %s': '%s में से पहली %s पंक्तियाँ दिखाई जा रही हैं',
  'Path copied to clipboard': 'पथ क्लिपबोर्ड पर कॉपी किया गया',
  'Toggle Path Copy Mode': 'पथ कॉपी मोड टॉगल करें',
  'Target folder': 'लक्ष्य फ़ोल्डर',
  'No folders': 'कोई फ़ोल्डर नहीं',
  Pinned: 'पिन किया गया',
