...
import { u as Rh } from "./index-oWiUCs-S.js";
let os = [], Xo = [];
(() => {
  ...
  setup(s, { emit: e }) {
    ...
    async function m(w) {
      ...
      switch (w) {
        ...
        case "jsonc":
        case "lock": {
          const { json: O } = await import("./index-BQL1Cvzj.js");
          v = O();
          break;
        }
        case "js":
        case "mjs":
        case "cjs": {
          const { javascript: O } = await import("./index-wegBJnMF.js").then((I) => I.i);
          v = O();
          break;
        }
        case "jsx": {
        ...
        case "html":
        case "htm": {
          const { html: O } = await import("./index-Dmeksqts.js");
          v = O();
          break;
        }
        case "css":
        ...
        case "sass":
        case "less": {
          const { css: O } = await import("./index-DqzQy_HB.js");
          v = O();
          break;
        }
        case "md":
        case "markdown": {
          const { markdown: O } = await import("./index-DLm9k67W.js");
          v = O();
          break;
        }
        case "yml":
        case "yaml": {
          const { yaml: O } = await import("./index-DSlzOYui.js");
          v = O();
          break;
        }
        case "xml":
        case "svg": {
          const { xml: O } = await import("./index-BcFLCnxT.js");
          v = O();
          break;
        }
        default:
